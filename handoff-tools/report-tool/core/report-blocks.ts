...
export const SECTION_BLOCKS: Record<string, BlockDef[]> = {
  overview: [
    ...
    {
      id: "engagement_kpis",
      label: "Engagement & Conversion KPIs",
      cards: [
  ...
  goals: [{ id: "goals_list", label: "Goals & Progress" }],
  youtube: [
    {
      id: "kpis",
