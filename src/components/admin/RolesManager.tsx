...
const PERMISSION_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "meta_audience_scraper", label: "Meta Audience Scraper" },
    ],
  },
  {
    label: "Meridian",
  ...
  },
  {
    ...
    items: [
      ...
      { key: "settings:searchconsole", label: "Google Search Console" },
      { key: "settings:woocommerce", label: "WooCommerce" },
      { key: "settings:shopify", label: "Shopify" },
      { key: "settings:tiktok", label: "TikTok Ads" },
      { key: "settings:microsoftads", label: "Microsoft Advertising" },
      { key: "settings:cwv", label: "Core Web Vitals" },
      { key: "settings:linkedin", label: "LinkedIn Ads" },
      { key: "settings:klaviyo", label: "Email (Klaviyo)" },
      { key: "settings:hubspot", label: "HubSpot CRM" },
      { key: "settings:youtube", label: "YouTube Analytics" },
      { key: "settings:callrail", label: "CallRail" },
      { key: "settings:competitors", label: "Competitor Intelligence" },
