...
const features = [
  { icon: <Layers size={20} />, title: "30+ data blocks", desc: "GA4 overview, Google Ads campaigns, Meta ad sets, SEO rankings, email performance, call tracking, ecommerce revenue. Each block pulls live data from the connected platform." },
  { icon: <Sparkles size={20} />, title: "AI-written commentary", desc: "Meridian reads the data for each section and writes commentary explaining what happened, why it matters, and what to do next. Edit it or use it as-is." },
  { icon: <GripVertical size={20} />, title: "Drag-and-drop builder", desc: "Reorder sections, toggle blocks on and off, add text sections between data blocks. The report builder works the way you think, not the way a spreadsheet does." },
  { icon: <Image size={20} />, title: "Image compression", desc: "Screenshots and custom images get compressed automatically on upload. Reports load fast and PDFs stay under email attachment limits." },
  { icon: <Share2 size={20} />, title: "Share links", desc: "Generate a unique link for any report. Send it to a client and they see a clean, read-only view. No login required. Revoke access any time." },
  { icon: <LayoutTemplate size={20} />, title: "Templates", desc: "Save a report layout as a template. Apply it to new clients or new reporting periods. Same structure, fresh data, in seconds." },
];
...
export default function ReportsPage() {
  ...
  return (
    <div style={{ background: "#09090f", color: "white", fontFamily: "inherit" }}>
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 50, backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", background: "rgba(9,9,15,0.88)", borderBottom: "1px solid rgba(255,255,255,0.06)", height: 64, display: "flex", alignItems: "center", padding: "0 40px", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ fontSize: 13, fontWeight: 700, color: "rgba(255,255,255,0.65)" }}>Reports</span>
          </div>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <a href="#cta" onClick={(e) => { e.preventDefault(); document.getElementById("cta")?.scrollIntoView({ behavior: "smooth" }); }} style={{ padding: "9px 20px", borderRadius: 8, background: `linear-gradient(135deg, #059669, ${accent})`, color: "white", fontSize: 13, fontWeight: 600, textDecoration: "none", boxShadow: `0 0 20px rgba(16,185,129,0.3)` }} className="cta-accent-pulse">Talk to us →</a>
        </div>
      </nav>
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 28, flexWrap: "wrap" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "6px 14px", borderRadius: 20, background: `rgba(16,185,129,0.12)`, border: `1px solid rgba(16,185,129,0.3)` }}>
                ...
                <span style={{ fontSize: 12, fontWeight: 700, color: accentLight, letterSpacing: "0.08em", textTransform: "uppercase" }}>Report builder</span>
              </div>
            </div>
            <h1 style={{ fontSize: 56, fontWeight: 900, lineHeight: 1.05, letterSpacing: "-0.04em", marginBottom: 28, color: "white" }}>
              ...
              <br />
              <span className="hw hw2" style={{ background: `linear-gradient(90deg, ${accentLight}, ${accent})`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>not Tuesday afternoon.</span>
            </h1>
            <p style={{ fontSize: 18, color: "rgba(255,255,255,0.6)", lineHeight: 1.8, maxWidth: 500, marginBottom: 32, fontWeight: 400 }}>
              30+ data blocks pulling live numbers from every connected platform. AI writes the commentary. Drag and drop to reorder. Export to PDF or send a share link. Done.
            </p>
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
              <a href="#features" onClick={(e) => { e.preventDefault(); document.getElementById("features")?.scrollIntoView({ behavior: "smooth" }); }} style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "13px 24px", borderRadius: 10, background: `linear-gradient(135deg, #059669, ${accent})`, color: "white", fontSize: 14, fontWeight: 600, textDecoration: "none", boxShadow: `0 0 24px rgba(16,185,129,0.35)` }} className="cta-accent-pulse">
            ...
            <div className="mockup-3d" style={{ background: "rgba(255,255,255,0.04)", border: `1px solid rgba(16,185,129,0.2)`, borderRadius: 20, overflow: "hidden", position: "relative" }}>
              <div style={{ padding: "18px 22px", borderBottom: "1px solid rgba(255,255,255,0.06)", display: "flex", alignItems: "center", justifyContent: "space-between", background: `rgba(16,185,129,0.05)` }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <div>
                    <div style={{ fontSize: 13, fontWeight: 700, color: "white" }}>March 2026 Report</div>
                    <div style={{ fontSize: 11, color: "rgba(255,255,255,0.4)", marginTop: 1 }}>Bright Sparks Ltd</div>
                  </div>
                </div>
                <div style={{ display: "flex", gap: 6 }}>
                  <div style={{ padding: "5px 10px", borderRadius: 6, fontSize: 10, fontWeight: 700, background: "rgba(16,185,129,0.12)", border: "1px solid rgba(16,185,129,0.25)", color: accentLight }}>PDF</div>
                  <div style={{ padding: "5px 10px", borderRadius: 6, fontSize: 10, fontWeight: 700, background: "rgba(99,102,241,0.12)", border: "1px solid rgba(99,102,241,0.25)", color: "#a5b4fc" }}>Share</div>
                </div>
              </div>
              {/* Section list */}
              <div style={{ display: "flex", flexDirection: "column" }}>
                {[
                  ...
                  <div key={i} style={{ padding: "12px 22px", borderBottom: "1px solid rgba(255,255,255,0.05)", display: "flex", alignItems: "center", gap: 10 }}>
                    <GripVertical size={12} color="rgba(255,255,255,0.2)" />
                    <div style={{ flex: 1 }}>
                      <div style={{ fontSize: 12, fontWeight: 600, color: "rgba(255,255,255,0.7)" }}>{sec.name}</div>
                      <div style={{ fontSize: 10, color: "rgba(255,255,255,0.3)", marginTop: 2 }}>{sec.blocks} blocks</div>
                    </div>
                    {sec.ai && (
                      <div style={{ display: "flex", alignItems: "center", gap: 4, padding: "2px 7px", borderRadius: 4, background: "rgba(16,185,129,0.1)", border: "1px solid rgba(16,185,129,0.2)" }}>
                        <Sparkles size={9} color={accentLight} />
                        <span style={{ fontSize: 9, fontWeight: 700, color: accentLight }}>AI</span>
                      </div>
                    )}
                    <div style={{ width: 24, height: 14, borderRadius: 7, background: "rgba(16,185,129,0.3)", position: "relative" }}>
                      <div style={{ width: 10, height: 10, borderRadius: "50%", background: accentLight, position: "absolute", right: 2, top: 2 }} />
                    </div>
                  </div>
                ))}
              </div>
              <div style={{ padding: "14px 22px", background: "rgba(16,185,129,0.03)" }}>
                <div style={{ fontSize: 11, color: "rgba(255,255,255,0.35)" }}>6 sections, 24 blocks, AI commentary enabled for 5 sections</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="stats-row" className="reveal-section" style={{ padding: "80px 40px", background: `linear-gradient(180deg, rgba(16,185,129,0.04) 0%, rgba(99,102,241,0.03) 100%)`, borderTop: "1px solid rgba(255,255,255,0.05)", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20 }} className="stats-grid">
            {[
              { val: s1, suffix: "+", label: "Data blocks available to build reports from", note: "Covering all 16 platforms", color: accent },
              { val: s2, suffix: "", label: "Section types from executive summary to ecommerce", note: "Modular and reorderable", color: "#6366f1" },
              { val: s3, suffix: " min", label: "Average time to build a complete client report", note: "With AI commentary enabled", color: "#f59e0b" },
            ].map((s, i) => (
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            ...
            <p style={{ fontSize: 16, color: "rgba(255,255,255,0.45)", maxWidth: 560, margin: "0 auto", lineHeight: 1.7 }}>
              Pick your sections, toggle the blocks you want, let the AI write the commentary. Save it as a template. Next month, the data updates itself.
            </p>
          </div>
      ...
      {/* ── SECTIONS ── */}
      <section id="sections" className="reveal-section" style={{ padding: "100px 40px", background: `linear-gradient(180deg, rgba(16,185,129,0.03) 0%, transparent 100%)`, borderTop: "1px solid rgba(255,255,255,0.05)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            <p style={{ fontSize: 12, fontWeight: 700, color: accentLight, letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 16 }} className="blur-reveal">Section types</p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 14 }} className="channels-grid">
            {sectionTypes.map((s, i) => (
              <div key={s.name} className="stagger-in" style={{ display: "flex", alignItems: "center", gap: 10, padding: "14px 16px", borderRadius: 12, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)", animationDelay: `${i * 0.04}s` }}>
                <div style={{ width: 10, height: 10, borderRadius: "50%", background: s.color, boxShadow: `0 0 6px ${s.color}`, flexShrink: 0 }} />
                <span style={{ fontSize: 13, fontWeight: 600, color: "rgba(255,255,255,0.7)" }}>{s.name}</span>
              </div>
            ))}
          </div>
          <div style={{ textAlign: "center", marginTop: 20 }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "8px 16px", borderRadius: 8, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)" }}>
              <Type size={12} color="rgba(255,255,255,0.4)" />
              <span style={{ fontSize: 12, color: "rgba(255,255,255,0.4)" }}>Plus custom text sections, images, and AI commentary blocks</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="mockup" className="reveal-section" style={{ padding: "120px 40px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            <p style={{ fontSize: 12, fontWeight: 700, color: accentLight, letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 16 }} className="blur-reveal">AI commentary</p>
            <h2 style={{ fontSize: 42, fontWeight: 800, letterSpacing: "-0.03em", marginBottom: 18, color: "white" }} className="blur-reveal">
          ...
          <div className="mockup-3d" style={{ background: "rgba(255,255,255,0.03)", border: `1px solid rgba(16,185,129,0.15)`, borderRadius: 20, overflow: "hidden", position: "relative" }}>
            <div style={{ padding: "20px 28px", borderBottom: "1px solid rgba(255,255,255,0.06)", display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <span style={{ fontSize: 15, fontWeight: 700, color: "white" }}>AI Commentary Preview</span>
              <div style={{ marginLeft: "auto", padding: "4px 10px", borderRadius: 6, background: "rgba(16,185,129,0.12)", border: "1px solid rgba(16,185,129,0.25)", fontSize: 10, fontWeight: 700, color: accentLight }}>Generated in 3s</div>
            </div>
            <div style={{ padding: "24px 28px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
                <BarChart3 size={14} color="#4285f4" />
                <span style={{ fontSize: 13, fontWeight: 700, color: "rgba(255,255,255,0.7)" }}>Google Ads Commentary</span>
              </div>
              <div style={{ fontSize: 14, color: "rgba(255,255,255,0.55)", lineHeight: 1.8, padding: "16px 20px", background: "rgba(16,185,129,0.04)", border: "1px solid rgba(16,185,129,0.1)", borderRadius: 12 }}>
                Google Ads delivered 4,291 clicks at a CPC of £1.24, a 12% improvement on last month. The brand campaign continues to perform well with a 9.2% CTR, though we noticed competitor bidding is pushing brand CPCs up slightly. The key win this month was the new landing page test on the &quot;summer packages&quot; ad group, which improved conversion rate from 3.1% to 4.8%. We recommend scaling this ad group by 20% next month while pausing the &quot;generic terms&quot; group that has a £42 CPA, well above the £25 target.
              </div>
              <div style={{ display: "flex", gap: 8, marginTop: 14 }}>
                <div style={{ padding: "6px 12px", borderRadius: 6, fontSize: 11, fontWeight: 600, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", color: "rgba(255,255,255,0.5)", cursor: "pointer" }}>Edit</div>
                <div style={{ padding: "6px 12px", borderRadius: 6, fontSize: 11, fontWeight: 600, background: "rgba(16,185,129,0.1)", border: "1px solid rgba(16,185,129,0.2)", color: accentLight, cursor: "pointer" }}>Regenerate</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="cta" className="reveal-section" style={{ padding: "120px 40px 140px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center", position: "relative" }}>
          ...
          <h2 style={{ fontSize: 50, fontWeight: 900, letterSpacing: "-0.04em", marginBottom: 20, color: "white", lineHeight: 1.05 }} className="blur-reveal">
            Stop dreading<br />
            <span style={{ background: `linear-gradient(90deg, ${accentLight}, ${accent}, #6366f1)`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>report day.</span>
          </h2>
          <p style={{ fontSize: 17, color: "rgba(255,255,255,0.55)", lineHeight: 1.8, marginBottom: 40 }}>
            The data is already in StratOS. The AI already knows what happened. You just pick the sections, hit generate, and send the link.
          </p>
          <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
            <a href="/login" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "15px 28px", borderRadius: 12, background: `linear-gradient(135deg, #059669, ${accent})`, color: "white", fontSize: 15, fontWeight: 700, textDecoration: "none", boxShadow: `0 0 32px rgba(16,185,129,0.4)` }} className="cta-accent-pulse">
          ...
          <p style={{ marginTop: 24, fontSize: 12, color: "rgba(255,255,255,0.25)" }}>No extra tools. No extra cost. Already part of your StratOS platform.</p>
        </div>
      </section>
