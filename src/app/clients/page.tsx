    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      {clients.length === 0 ? (
        <div className="rounded-xl border border-dashed border-slate-700 p-12 text-center">
          ...
          <Link
            href="/clients/new"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-indigo-500 hover:bg-indigo-600 text-white text-sm font-medium transition"
          >
            <Plus className="h-4 w-4" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-white font-semibold truncate group-hover:text-indigo-300 transition">
                    {client.name}
                  </h3>
                  {client.website && (
                ...
                <ArrowRight className="h-4 w-4 text-slate-600 group-hover:text-indigo-400 transition shrink-0 mt-1" />
              </div>
              ...
              <div className="flex flex-wrap gap-1.5 mt-4">
                ...
                {!client.semrushDomain && !client.ga4PropertyId && !client.metaAccountId && (
                  <span className="text-xs text-slate-600">No integrations</span>
                )}
              </div>
          ...
          >
            ...
            <p className="text-sm text-slate-400">Add new client</p>
          </Link>
        </div>
      )}
    </div>
