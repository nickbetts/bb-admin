...
const features = [
  {
    icon: <Search size={20} />,
    title: "Built from real research",
    desc: "Connect a keyword planner project and the proposal populates itself. Keywords, forecasts, ad group structure. No copy-pasting from spreadsheets.",
  },
  {
    icon: <Link2 size={20} />,
    title: "Shareable links",
    desc: "Every proposal gets a unique share link. Send it to a prospect and they can view the full proposal in their browser without logging in.",
  },
  {
    icon: <Eye size={20} />,
    title: "View tracking",
    desc: "See exactly when a prospect opens your proposal, how many times, and from where. Know who is engaged before you follow up.",
  },
  {
    icon: <Mail size={20} />,
    title: "Enquiry capture",
    desc: "Prospects can submit questions or express interest directly from the proposal page. The enquiry lands in your dashboard with full attribution.",
  },
  {
    icon: <BarChart3 size={20} />,
    title: "Forecasts included",
    desc: "30, 60, and 90-day traffic and conversion forecasts pulled from the keyword planner. Prospects see the projected numbers, not just the keywords.",
  },
  {
    icon: <Pencil size={20} />,
    title: "Fully editable",
    desc: "Auto-generated does not mean locked. Edit titles, sections, add custom notes, rearrange content. Make it yours before you send it.",
  },
];
      ...
      >
        ...
        >
          <div>
            ...
            >
              Auto-generate proposals from keyword planner research. Share with a link, track who
              opens them, and capture enquiries directly from the proposal page.
            </p>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          >
            {[
              {
                val: s1,
                suffix: " forecast periods",
                label: "30, 60, and 90-day projections included in every proposal",
                note: "Built from keyword data",
                color: accent,
              },
              {
                val: s2,
                suffix: "%",
                label: "Auto-generated from your existing keyword research",
                note: "No manual entry needed",
                color: "#6366f1",
              },
              {
                val: "Live",
                suffix: "",
                label: "View tracking shows when prospects open your link",
                note: "Real-time engagement data",
                color: "#f59e0b",
                isText: true,
              },
            ].map((s, i) => (
      ...
      <section id="features" className="reveal-section" style={{ padding: "120px 40px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            ...
            >
              Every proposal connects to your keyword planner research. The data flows in, the
              forecast builds itself, and you send a professional proposal with one link.
            </p>
          </div>
          <div
            style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20 }}
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          >
            <div style={{ padding: "20px 28px", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
              ...
              >
                Your proposals dashboard
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 12 }}>
                {[
                  {
                    client: "Bright Sparks Ltd",
                    domain: "brightsparks.co.uk",
                    views: 12,
                    enquiries: 1,
                    status: "Active",
                  },
                  {
                    client: "Northern Fitness",
                    domain: "northernfitness.com",
                    views: 8,
                    enquiries: 0,
                    status: "Active",
                  },
                  {
                    client: "Peak Roofing",
                    domain: "peakroofing.co.uk",
                    views: 3,
                    enquiries: 0,
                    status: "Draft",
                  },
                  {
                    client: "Valley Dental",
                    ...
                    >
                      ...
                      <span
                        style={{
                          ...
                          color: p.status === "Active" ? accentLight : "rgba(255,255,255,0.3)",
                        }}
                      >
                        {p.status}
                      </span>
                    ...
                    <div style={{ display: "flex", gap: 12 }}>
                      ...
                      <div
                        style={{
                          ...
                          gap: 4,
                          fontSize: 10,
                          color: p.enquiries > 0 ? accentLight : "rgba(255,255,255,0.4)",
                        }}
                      >
                        <Users size={10} /> {p.enquiries} enquiries
                      </div>
                    </div>
                  </div>
                ))}
      ...
      >
        ...
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center", position: "relative" }}>
          ...
          <h2
            ...
            className="blur-reveal"
          >
            Turn research into signed briefs.
            <br />
            <span
              style={{
          ...
          >
            Your keyword research already exists. The proposal builder turns it into a professional
            document with forecasts, share links, and engagement tracking.
          </p>
          ...
          <p style={{ marginTop: 24, fontSize: 12, color: "rgba(255,255,255,0.25)" }}>
            No extra cost. Proposals are part of every StratOS plan.
          </p>
        </div>
      </section>
