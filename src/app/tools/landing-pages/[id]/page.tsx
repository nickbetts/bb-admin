...
// Canonical links use <subdomain>.<NEXT_PUBLIC_LP_ROOT_DOMAIN>/<slug>.
const LP_ROOT_DOMAIN = process.env.NEXT_PUBLIC_LP_ROOT_DOMAIN || "bettsandburton.com";
...
/** Best public URL for a landing page — uses subdomain host routing. */
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <button
            onClick={() => {
              ...
              try {
                setSettingsPlatforms(JSON.parse(lp.platforms ?? "[]"));
              } catch {
            ...
            return liveUrl ? (
              ...
              >
                ...
                <a
                  ...
                  title="Open live URL"
                >
                  {subdomain}.{LP_ROOT_DOMAIN}/{lp.slug}
                </a>
              </p>
            ) : (
          ...
          <div className="card" style={{ width: "100%", maxWidth: 480 }}>
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <span style={{ fontWeight: 400, color: "var(--text-4)" }}>
                    — the part before .{LP_ROOT_DOMAIN}
                  </span>
                </label>
              ...
              <div>
                ...
                >
                  Ad platforms{" "}
                  <span style={{ fontWeight: 400, color: "var(--text-4)" }}>(internal tag)</span>
                </label>
                <div style={{ display: "flex", gap: 8 }}>
                  {(
                    ...
                    const active = settingsPlatforms.includes(key);
                    return (
                      <button
                        key={key}
                        type="button"
