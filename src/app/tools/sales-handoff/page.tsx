                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex flex-col">
                    {serviceOptions.map((service, index) => {
                      ...
                      return (
                        <div key={service}>
                          {index > 0 && <div aria-hidden="true" className="h-3" />}
                          <button
                            type="button"
                            onClick={() => toggleService(service)}
                            className={cn(
                              "flex items-center justify-between gap-3 rounded-xl border px-4 py-3.5 text-sm font-medium transition-all duration-200",
                              checked
                                ? "border-indigo-300 bg-indigo-50 text-indigo-900 shadow-sm hover:border-indigo-400 hover:shadow-md dark:border-indigo-700/60 dark:bg-indigo-950/40 dark:text-indigo-100 dark:hover:border-indigo-600"
                                : "border-zinc-200 bg-white text-zinc-700 hover:border-indigo-300 hover:bg-indigo-50/60 hover:shadow-sm dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-300 dark:hover:border-indigo-700/50 dark:hover:bg-indigo-950/30",
                            )}
                          >
                            <span>{service}</span>
                            {checked && (
