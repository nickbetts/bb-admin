...
const features = [
  {
    icon: <Layers size={20} />,
    title: "Ad group segmentation",
    desc: "Keywords are automatically grouped into logical ad groups. Start your campaigns with structure already in place, not a flat keyword list.",
  },
  {
    icon: <TrendingUp size={20} />,
    title: "Forecast modelling",
    desc: "30, 60, and 90-day forecasts for clicks, impressions, and spend. Based on real Google Ads data, not estimates from third-party tools.",
  },
  {
    icon: <DollarSign size={20} />,
    title: "Budget estimation",
    desc: "See estimated monthly spend based on your target position and competition level. High, medium, and low bid ranges for each keyword.",
  },
  {
    icon: <Calendar size={20} />,
    title: "Seasonal trends",
    desc: "12-month search volume trends for every keyword. Spot seasonal patterns and plan campaigns around peak demand periods.",
  },
  {
    icon: <BarChart3 size={20} />,
    title: "Competition levels",
    desc: "LOW, MEDIUM, and HIGH competition badges from Google Ads. Know which keywords are contested and which have room to compete.",
  },
  {
    icon: <FileSignature size={20} />,
    title: "One-click proposals",
    desc: "Turn any keyword research project into a proposal with one click. Keywords, forecasts, and ad group structure flow straight into the proposal builder.",
  },
];

const sampleKeywords = [
  {
    kw: "ppc agency manchester",
    vol: "1,200",
    cpc: "£8.40",
    comp: "HIGH",
    trend: [40, 55, 48, 62, 70, 65, 80, 75, 90, 85, 78, 72],
  },
  {
    ...
    cpc: "£12.10",
    comp: "HIGH",
    trend: [60, 58, 65, 70, 72, 68, 75, 80, 82, 78, 74, 70],
  },
  {
    kw: "paid search services uk",
    vol: "880",
    cpc: "£6.90",
    comp: "MED",
    trend: [30, 35, 28, 40, 42, 38, 45, 50, 48, 44, 40, 36],
  },
  {
    ...
    cpc: "£4.20",
    comp: "MED",
    trend: [80, 82, 78, 85, 90, 88, 92, 95, 98, 94, 90, 86],
  },
  {
    kw: "digital marketing agency",
    vol: "8,100",
    cpc: "£9.80",
    comp: "HIGH",
    trend: [70, 72, 68, 75, 78, 76, 80, 82, 85, 80, 78, 74],
  },
];
  ...
  return (
    <div style={{ background: "#09090f", color: "white", fontFamily: "inherit" }}>
      ...
      >
        ...
        >
          <div>
            ...
            >
              Keyword research powered by the Google Ads API. Real volume, CPC, competition data,
              12-month trends, and forecast modelling. Then generate a proposal in one click.
            </p>
            ...
            >
              ...
              <div style={{ padding: "10px 16px" }}>
                <div
                  style={{
                    display: "grid",
                    gridTemplateColumns: "2fr 60px 60px 50px 80px",
                    gap: 6,
                    padding: "8px 6px",
                ...
                {sampleKeywords.map((kw, i) => (
                  ...
                  >
                    ...
                    <div
                      style={{ fontSize: 11, color: "rgba(255,255,255,0.5)", textAlign: "right" }}
                    >
                      {kw.vol}
                    </div>
                    <div
                    ...
                    <div style={{ textAlign: "center" }}>
                      <span
                        style={{
                          ...
                          borderRadius: 3,
                          background:
                            kw.comp === "HIGH" ? "rgba(239,68,68,0.1)" : "rgba(245,158,11,0.1)",
                          border:
                            kw.comp === "HIGH"
                              ? "1px solid rgba(239,68,68,0.25)"
                              : "1px solid rgba(245,158,11,0.25)",
                          color: kw.comp === "HIGH" ? "#fca5a5" : "#fcd34d",
                        }}
                      >
                        {kw.comp}
                      </span>
                      ...
                      {kw.trend.map((v, j) => (
                        <div
                          ...
                          style={{
                            ...
                            height: `${(v / 100) * 16}px`,
                            borderRadius: 1,
                            background: `rgba(59,130,246,${0.3 + (v / 100) * 0.5})`,
                          }}
                        />
                      ))}
                    </div>
      ...
      <section
        ...
        style={{
          padding: "80px 40px",
          background: `linear-gradient(180deg, rgba(59,130,246,0.04) 0%, rgba(16,185,129,0.03) 100%)`,
          borderTop: "1px solid rgba(255,255,255,0.05)",
            ...
            {[
              {
                val: s1,
                suffix: "-month",
                label: "Search volume trends shown for every keyword you research",
                note: "Spot seasonal patterns",
                color: accent,
              },
              {
                val: s2,
                suffix: " forecasts",
                label: "30, 60, and 90-day projections for clicks, impressions, spend",
                note: "Real Google Ads data",
                color: "#10b981",
              },
              {
                val: "1-click",
                suffix: "",
                label: "Generate a proposal from any keyword research project",
                note: "Keywords flow into proposals",
                color: "#f59e0b",
                isText: true,
              },
            ].map((s, i) => (
      ...
      <section id="features" className="reveal-section" style={{ padding: "120px 40px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            ...
            >
              Every number comes from the Google Ads API. Volume, CPC, competition, and forecasts
              are all based on actual auction data, not third-party estimates.
            </p>
          </div>
          <div
            style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20 }}
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12 }}>
                {[
                  ...
                  >
                    ...
                    {m.delta && (
                      <div
                        style={{ fontSize: 10, color: "#6ee7b7", fontWeight: 600, marginTop: 4 }}
                      >
                        {m.delta} vs prev 90d
                      </div>
                    )}
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    padding: "12px",
                    borderRadius: 8,
                    background: i === 2 ? `rgba(59,130,246,0.08)` : "rgba(255,255,255,0.02)",
                    border:
                      i === 2
                ...
                >
                  <div
                    style={{
                      fontSize: 11,
                      fontWeight: 700,
                      color: i === 2 ? accentLight : "rgba(255,255,255,0.4)",
                      textTransform: "uppercase",
                      letterSpacing: "0.06em",
                      marginBottom: 6,
                    }}
      ...
      >
        ...
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center", position: "relative" }}>
          ...
          <h2
            ...
            className="blur-reveal"
          >
            Stop researching in spreadsheets.
            <br />
            <span
              style={{
          ...
          >
            Research, forecast, propose. All in one tool, all backed by real Google Ads data. No
            exports, no reformatting, no wasted time.
          </p>
          ...
          <p style={{ marginTop: 24, fontSize: 12, color: "rgba(255,255,255,0.25)" }}>
            Google Ads API integration included. Keyword Planner is part of every StratOS plan.
          </p>
        </div>
      </section>
