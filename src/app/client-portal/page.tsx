...
export default function ClientPortalPage() {
  const accent = "#c084fc";
  const accentLight = "#e9d5ff";
  const accentGlow = "rgba(192,132,252,0.6)";
  ...
  return (
    <div style={{ background: "#09090f", color: "white", fontFamily: "inherit" }}>
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 50, backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", background: "rgba(9,9,15,0.88)", borderBottom: "1px solid rgba(255,255,255,0.06)", height: 64, display: "flex", alignItems: "center", padding: "0 40px", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ fontSize: 13, fontWeight: 700, color: "rgba(255,255,255,0.65)" }}>Client Portal</span>
          </div>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <a href="#cta" onClick={(e) => { e.preventDefault(); document.getElementById("cta")?.scrollIntoView({ behavior: "smooth" }); }} style={{ padding: "9px 20px", borderRadius: 8, background: `linear-gradient(135deg, ${accent}, #a855f7)`, color: "white", fontSize: 13, fontWeight: 600, textDecoration: "none", boxShadow: `0 0 20px rgba(192,132,252,0.3)` }} className="cta-accent-pulse">Talk to us →</a>
        </div>
      </nav>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "80px 40px", display: "grid", gridTemplateColumns: "1fr 480px", gap: 72, alignItems: "center", width: "100%", position: "relative", boxSizing: "border-box" }} className="hero-grid">
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 36 }}>
              {[
                "Magic-link auth: zero passwords to manage",
                "Permission-based visibility per client",
                "Latest reports surface automatically",
                "Goal tracking and communications timeline",
              ].map((item, i) => (
      ...
      <style>{`
        ...
        @keyframes accent-pulse-anim { 0%, 100% { opacity: 1; box-shadow: 0 0 10px rgba(192,132,252,0.9); } 50% { opacity: 0.35; box-shadow: 0 0 24px rgba(192,132,252,0.2); } }
        ...
        @keyframes pulse-accent { 0%, 100% { box-shadow: 0 0 20px rgba(192,132,252,0.4); } 50% { box-shadow: 0 0 40px rgba(192,132,252,0.75), 0 0 80px rgba(192,132,252,0.15); } }
        ...
        .feature-card:hover { transform: translateY(-6px) scale(1.015) !important; border-color: rgba(192,132,252,0.2) !important; box-shadow: 0 16px 48px rgba(192,132,252,0.12); }
        .stat-card:hover { transform: translateY(-6px) scale(1.025) !important; border-color: rgba(192,132,252,0.2) !important; box-shadow: 0 16px 48px rgba(192,132,252,0.12); }
        @keyframes card-float { 0%, 100% { transform: translateY(0px); } 50% { transform: translateY(-10px); } }
        @keyframes card-glow { 0%, 100% { box-shadow: 0 4px 32px rgba(192,132,252,0.08), 0 0 0 1px rgba(192,132,252,0.1); } 50% { box-shadow: 0 8px 48px rgba(192,132,252,0.22), 0 0 0 1px rgba(192,132,252,0.2); } }
        ...
        .mockup-3d::after { content: ''; position: absolute; left: 0; right: 0; top: 0; height: 1px; background: linear-gradient(90deg, transparent 0%, rgba(192,132,252,0.6) 40%, rgba(192,132,252,0.8) 50%, rgba(192,132,252,0.6) 60%, transparent 100%); animation: scan-line 8s ease-in-out infinite; pointer-events: none; }
