...
const features = [
  {
    ...
    title: "Multi-metric forecasting",
    desc: "Forecast impressions, clicks, conversions, revenue, and cost across channels. Each metric gets its own projection model.",
  },
  {
    icon: <Gauge size={20} />,
    title: "Confidence intervals",
    desc: "Every forecast shows expected, best-case, and worst-case bounds. The confidence range reflects actual variance in your historical data.",
  },
  {
    icon: <Clock size={20} />,
    title: "30/60/90-day windows",
    desc: "Three horizons in every forecast. Short-term predictions are tighter. Longer windows show wider ranges. Pick the period that fits the conversation.",
  },
  {
    icon: <MessageSquare size={20} />,
    title: "Narrative explanations",
    desc: "The AI writes a plain-English summary of what the forecast means. Trends, risks, and seasonal patterns explained in context.",
  },
  {
    icon: <Layers size={20} />,
    title: "Historical context",
    desc: "Forecasts sit alongside actual historical performance. See how the projection compares to last month, last quarter, and year-on-year.",
  },
  {
    icon: <AlertTriangle size={20} />,
    title: "Risk flagging",
    desc: "If a forecast shows potential decline, it gets flagged. The AI explains why and suggests what to monitor. No surprises.",
  },
];
  ...
  return (
    <div style={{ background: "#09090f", color: "white", fontFamily: "inherit" }}>
      ...
      >
        ...
        >
          <div>
            ...
            >
              Predictive projections with confidence intervals. Not benchmarks. Not industry
              averages. Your numbers, projected forward with ranges that reflect real variance.
            </p>
            ...
            >
              ...
              <div style={{ padding: "20px 22px" }}>
                <svg viewBox="0 0 440 160" style={{ width: "100%", height: "auto" }}>
                  ...
                  <path
                    d="M0,120 L73,110 L146,95 L220,85 L293,70 L366,55 L440,40 L440,90 L366,100 L293,110 L220,115 L146,120 L73,125 L0,130 Z"
                    fill="rgba(96,165,250,0.08)"
                    stroke="none"
                  />
                  {/* Expected line */}
                  <path
                    d="M0,125 L73,118 L146,108 L220,100 L293,90 L366,78 L440,65"
                    fill="none"
                    stroke={accent}
                    strokeWidth="2.5"
                    strokeLinecap="round"
                  ...
                  {/* Best case dashed */}
                  <path
                    d="M220,85 L293,70 L366,55 L440,40"
                    fill="none"
                  ...
                  {/* Worst case dashed */}
                  <path
                    d="M220,115 L293,110 L366,100 L440,90"
                    fill="none"
                  ...
                  <line
                    ...
                    strokeDasharray="3,3"
                  />
                  <text x="210" y="8" fill="rgba(255,255,255,0.3)" fontSize="8" textAnchor="end">
                    Historical
                  </text>
                  <text x="230" y="8" fill={accent} fontSize="8">
                    Forecast
                  </text>
                  {/* Data points */}
                  {[
              ...
              >
                {[
                  ...
                  >
                    ...
                    <div style={{ fontSize: 10, color: m.colour, fontWeight: 600, marginTop: 2 }}>
                      {m.change} projected
                    </div>
                  </div>
                ))}
      ...
      <section
        ...
        style={{
          padding: "80px 40px",
          background: `linear-gradient(180deg, rgba(96,165,250,0.04) 0%, rgba(59,130,246,0.03) 100%)`,
            ...
            {[
              {
                val: s1,
                suffix: " horizons",
                label: "30, 60, and 90-day projection windows for every metric",
                note: "Short, medium, and long range",
                color: accent,
              },
              {
                val: s2,
                suffix: " metrics",
                label: "Impressions, clicks, conversions, revenue, and cost forecasted",
                note: "Cross-channel projections",
                color: "#3b82f6",
              },
              {
                val: s3,
                suffix: " bands",
                label: "Expected, best-case, and worst-case confidence intervals",
                note: "Variance-based ranges",
                color: "#10b981",
              },
            ].map((s, i) => (
              <div
      ...
      <section id="features" className="reveal-section" style={{ padding: "120px 40px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            ...
            >
              The AI reads your historical performance, identifies trends and seasonal patterns, and
              projects forward with confidence ranges that reflect real variance.
            </p>
          </div>
          <div
            style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20 }}
            ...
            <div style={{ padding: "24px 28px" }}>
              ...
              >
                <p style={{ marginBottom: 14 }}>
                  Google Ads conversions have trended upward over the past 90 days, averaging 11.2
                  per day. The 30-day projection is{" "}
                  <strong style={{ color: "white" }}>342 conversions</strong> (best case 380, worst
                  case 305).
                </p>
                <p style={{ marginBottom: 14 }}>
                  Seasonal patterns suggest a lift in April and May, consistent with last year. The
                  60-day and 90-day projections reflect this, with expected totals of{" "}
                  <strong style={{ color: "white" }}>698</strong> and{" "}
                  <strong style={{ color: "white" }}>1,060</strong> respectively.
                </p>
                <p style={{ marginBottom: 0 }}>
                  ...
                  If CPC continues to rise at the current rate (+3.2% month-on-month), conversion
                  volume may flatten in the 60-90 day range unless budget is increased or targeting
                  is narrowed.
                </p>
              </div>
            </div>
      ...
      >
        ...
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center", position: "relative" }}>
          ...
          >
            ...
            <span
              style={{
                background: `linear-gradient(90deg, ${accentLight}, ${accent}, #3b82f6)`,
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
              }}
            >
          ...
          >
            Every client gets predictive forecasts. Real data, real variance, real ranges. Not a
          ...
          <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
            <a
              ...
              style={{
                ...
                fontWeight: 700,
                textDecoration: "none",
                boxShadow: `0 0 32px rgba(96,165,250,0.4)`,
              }}
              className="cta-accent-pulse"
            >
          ...
          <p style={{ marginTop: 24, fontSize: 12, color: "rgba(255,255,255,0.25)" }}>
            AI forecasting included with every StratOS plan.
          </p>
        </div>
      </section>
