...
function PortalLoginInner() {
  ...
  const [status, setStatus] = useState<"idle" | "loading" | "sent" | "error" | "authenticating">(
    () => (token ? "authenticating" : "idle"),
  );
          ...
          {status === "authenticating" ? (
            ...
            <div style={{ textAlign: "center", padding: "20px 0" }}>
              ...
              <p style={{ fontSize: 13, color: "var(--text-3)", marginTop: 6, lineHeight: 1.6 }}>
                Contact your account manager to request a login link. Links are sent by the agency
            ...
            <>
              ...
              <p
                style={{ fontSize: 13, color: "var(--text-3)", marginBottom: 24, lineHeight: 1.6 }}
              >
                Access your marketing performance data, reports, and goals. Your agency will send
                you a magic login link.
              </p>
