...
const features = [
  {
    ...
    desc: "Google Ads and Meta spend analysed together. The AI reads performance data from both platforms and compares campaign-level efficiency.",
  },
  {
    icon: <Eye size={20} />,
    title: "Opportunity detection",
    desc: "Finds campaigns with lost impression share, high CPA, or underperforming ROAS. Each opportunity is sized with an estimated impact.",
  },
  {
    icon: <ArrowRightLeft size={20} />,
    title: "Reallocation recommendations",
    desc: "Specific suggestions for where to move budget. Not generic advice. Actual campaign names, actual amounts, actual projected outcomes.",
  },
  {
    icon: <TrendingUp size={20} />,
    title: "Impact projections",
    desc: "Every recommendation comes with a projected uplift. How many extra conversions. What the ROAS would look like. Grounded in your actual data.",
  },
  {
    icon: <BarChart3 size={20} />,
    title: "Ad group context",
    desc: "Drill into ad group performance within each campaign. See which groups are pulling weight and which are dragging the average down.",
  },
  {
    icon: <Zap size={20} />,
    title: "Live API data",
    desc: "Recommendations use the latest data from Google Ads and Meta APIs. Not last month. Not an export. Current performance with cache refresh.",
  },
];
...
export default function BudgetIntelligencePage() {
  ...
  return (
    <div style={{ background: "#09090f", color: "white", fontFamily: "inherit" }}>
      ...
      <LandingNav
        currentPage="Budget Intelligence"
        accentColor={accent}
      ...
      >
        ...
        >
          <div>
            ...
            >
              Cross-channel budget recommendations backed by live performance data. The AI finds
              where money is being wasted and where it could work harder.
            </p>
          ...
          <div style={{ position: "relative" }}>
            ...
            >
              ...
              >
                {[
                  {
                    campaign: "Summer Camps - Search",
                    platform: "Google Ads",
                    current: "2,400",
                    recommended: "3,200",
                    change: "+33%",
                    reason: "Lost IS: 28% due to budget",
                  ...
                  },
                  {
                    ...
                    recommended: "1,200",
                    change: "-33%",
                    reason: "CPM up 42% vs Q4, low CTR",
                    impact: "Reallocate to Search",
                    impactColour: "#f59e0b",
                  },
                  {
                    campaign: "Retargeting - All",
                    platform: "Meta",
                    current: "900",
                    recommended: "900",
                    change: "0%",
                    reason: "ROAS 6.2x - performing well",
                    impact: "No change needed",
                    impactColour: "rgba(255,255,255,0.3)",
                  },
                ].map((row, i) => (
                  <div
                    key={i}
                  ...
                  >
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                          <span
                            style={{
                              ...
                              textDecoration: row.change !== "0%" ? "line-through" : "none",
                            }}
                          >
                            {row.current}
                          </span>
                    ...
                    >
                      ...
                      <span style={{ fontSize: 10, fontWeight: 600, color: row.impactColour }}>
                        {row.impact}
                      </span>
                    </div>
                  </div>
      ...
      <section
        ...
        style={{
          padding: "80px 40px",
          background: `linear-gradient(180deg, rgba(245,158,11,0.04) 0%, rgba(217,119,6,0.03) 100%)`,
            ...
            {[
              {
                val: s1,
                suffix: " platforms",
                label: "Google Ads and Meta spend analysed side by side",
                note: "Cross-channel intelligence",
                color: accent,
              },
              {
                val: s2,
                suffix: "% live",
                label: "Recommendations use the latest API data, not exports",
              ...
              },
              {
                val: "AI",
                suffix: " written",
                label: "Every recommendation includes projected impact and reasoning",
                note: "Actionable, not generic",
                color: "#10b981",
                isText: true,
              },
            ].map((s, i) => (
      ...
      <section id="features" className="reveal-section" style={{ padding: "120px 40px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            ...
            >
              The AI reads live performance from Google Ads and Meta, spots inefficiency, and writes
              recommendations with projected impact. Not theory. Your actual campaigns.
            </p>
          </div>
          <div
            style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20 }}
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          >
            <div style={{ padding: "24px 28px" }}>
              ...
              >
                <strong style={{ color: accentLight }}>Summary:</strong> Moving GBP 600 from Meta
                Brand Awareness to Google Search Summer Camps would recover 28% lost impression
                share and generate an estimated 18 additional conversions per month. Retargeting is
                performing well and should keep its current allocation. Review in 2 weeks after
                changes take effect.
              </div>
            </div>
          </div>
      ...
      >
        ...
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center", position: "relative" }}>
          ...
          >
            ...
            <span
              style={{
                background: `linear-gradient(90deg, ${accentLight}, ${accent}, #d97706)`,
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
              }}
            >
          ...
          >
            Budget intelligence gives you campaign-level recommendations backed by live data. Move
          ...
          <p style={{ marginTop: 24, fontSize: 12, color: "rgba(255,255,255,0.25)" }}>
            Budget Intelligence is included with every StratOS plan.
          </p>
        </div>
      </section>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span>
            &copy; {new Date().getFullYear()} i3 Media. Budget Intelligence is part of StratOS.
          </span>
        </div>
        <a
          href="/login"
