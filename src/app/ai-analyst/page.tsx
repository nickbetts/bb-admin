...
const features = [
  {
    ...
    desc: "Every response pulls from every connected platform. GA4, Google Ads, Meta, SEO, email, call tracking. The AI reads all of it before answering.",
  },
  {
    icon: <History size={20} />,
    title: "Conversation memory",
    desc: "Ask follow-up questions without repeating yourself. The AI remembers your last 10 messages and keeps context throughout the conversation.",
  },
  {
    icon: <Lightbulb size={20} />,
    title: "Suggested prompts",
    desc: "Not sure what to ask? The AI suggests relevant questions based on what is happening in the account right now. Click one to get started.",
  },
  {
    icon: <MessageSquare size={20} />,
    title: "Floating panel",
    desc: "The AI analyst lives in a slide-out panel on any client page. Ask a question without leaving the dashboard. No page changes, no context lost.",
  },
  {
    icon: <Sparkles size={20} />,
    title: "Real-time streaming",
    desc: "Responses stream in token by token. You can read the answer as it is being written, just like talking to someone who thinks fast.",
  },
  {
    icon: <Zap size={20} />,
    title: "Actionable follow-ups",
    desc: "After each response, the AI suggests follow-up questions you might want to ask. It helps you dig deeper without having to figure out the next prompt.",
  },
];
...
export default function AiAnalystPage() {
  ...
  const { scrollPct, activeSection, mouse, statsVisible, parallaxY } = useLandingPageMotion({
    navIds,
  });
  ...
  return (
    <div style={{ background: "#09090f", color: "white", fontFamily: "inherit" }}>
      ...
      >
        ...
        >
          <div>
            ...
            >
              Natural language queries that read every connected platform before responding. Ask
              about performance, trends, anomalies, or recommendations. The AI has the same data you
              do.
            </p>
          ...
          <div style={{ position: "relative" }}>
            ...
            >
              ...
              {/* Messages */}
              <div
                style={{ display: "flex", flexDirection: "column", gap: 16, padding: "20px 22px" }}
              >
                {/* User message */}
                <div style={{ display: "flex", gap: 10, justifyContent: "flex-end" }}>
                  ...
                  >
                    <div style={{ fontSize: 13, color: "rgba(255,255,255,0.8)", lineHeight: 1.5 }}>
                      Why did our Google Ads CPA go up this month?
                    </div>
                  </div>
                  <div
                    style={{
                ...
                <div style={{ display: "flex", gap: 10 }}>
                  ...
                  >
                    <div style={{ fontSize: 13, color: "rgba(255,255,255,0.65)", lineHeight: 1.7 }}>
                      Your Google Ads CPA increased from £18.40 to £24.10 (+31%) this month. Three
                      factors contributed:
                    </div>
                    <div
                    ...
                    >
                      {[
                        ...
                        >
                          <span style={{ color: accentLight, fontWeight: 700, flexShrink: 0 }}>
                            {i + 1}.
                          </span>
                          <span>{point}</span>
                        </div>
              ...
              <div style={{ padding: "12px 22px", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
                ...
                <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                  {[
                    "Which keywords should we pause?",
                    "Show me the landing page data",
      ...
      <section
        ...
        style={{
          padding: "80px 40px",
          background: `linear-gradient(180deg, rgba(129,140,248,0.04) 0%, rgba(16,185,129,0.03) 100%)`,
          borderTop: "1px solid rgba(255,255,255,0.05)",
            ...
            {[
              {
                val: s1,
                suffix: "",
                label: "Platforms queried for every response you receive",
                note: "Full cross-channel context",
                color: accent,
              },
              {
                val: s2,
                suffix: "",
                label: "Message context window for follow-up conversations",
                note: "Remembers conversation history",
                color: "#10b981",
              },
              {
                val: s3,
                suffix: "",
                label: "Suggested prompts based on live account data",
                note: "Personalised to each client",
                color: "#f59e0b",
              },
            ].map((s, i) => (
              <div
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            ...
            >
              Not a chatbot.
              <br />
              An analyst that reads everything.
            </h2>
            <p
              style={{
                fontSize: 16,
            ...
            >
              The AI Analyst connects to every platform your client uses. When you ask a question,
              it pulls the relevant data, compares periods, and gives you a straight answer with
              sources.
            </p>
          </div>
          <div
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          >
            <div style={{ padding: "20px 28px", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
              ...
              >
                What data does the AI read for each response?
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 10 }}>
                {[
                  {
                    platform: "GA4",
                    metrics: "Sessions, conversions, bounce rate, traffic sources, landing pages",
                  },
                  {
                    platform: "Google Ads",
                    metrics: "Spend, CPC, CTR, conversions, ROAS, search terms, ad groups",
                  },
                  {
                    platform: "Meta Ads",
                    metrics: "Spend, CPM, CTR, conversions, audience, placements, creative",
                  },
                  {
                    platform: "SEO",
                    metrics: "Rankings, visibility, organic traffic, keywords, backlinks",
                  },
                  {
                    platform: "Email",
                    metrics: "Opens, clicks, revenue, unsubscribes, campaign performance",
                  },
                  {
                    platform: "Calls",
                    metrics: "Call volume, sources, duration, first-time callers",
                  },
                ].map((p, i) => (
                  <div
                    key={i}
                  ...
                  >
                    <div
                      style={{ fontSize: 11, fontWeight: 700, color: accentLight, marginBottom: 4 }}
                    >
                      {p.platform}
                    </div>
            ...
            <div style={{ padding: "18px 28px", background: `rgba(129,140,248,0.03)` }}>
              <div style={{ fontSize: 12, color: "rgba(255,255,255,0.4)", lineHeight: 1.6 }}>
                Every question you ask triggers a data pull across all connected platforms for that
                client. The AI reads the numbers, compares to historical performance, identifies
                trends, and answers your question with specific data points and source citations.
              </div>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center", position: "relative" }}>
          ...
          >
            The AI Analyst is available on every client dashboard. Click the chat icon, type your
            question, and get an answer that references real data from every connected platform.
          </p>
          ...
          <p style={{ marginTop: 24, fontSize: 12, color: "rgba(255,255,255,0.25)" }}>
            Powered by Meridian. No extra tools. Built into every StratOS dashboard.
          </p>
        </div>
      </section>
