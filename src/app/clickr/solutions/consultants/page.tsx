...
import {
  Zap, Clock, ArrowRight, CheckCircle, Star,
  BarChart2, Share2, Layers, Globe, MessageSquare,
  GitBranch, FileText, Wallet,
} from "lucide-react";
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://clickr.marketing/solutions/consultants" },
  openGraph: {
    title: "clickr for Consultants & Freelancers | Deliver More, Faster",
    description: "Deliver fully-branded, CRO-optimised landing pages for every client campaign. No designers, no handoffs, no waiting.",
    url: "https://clickr.marketing/solutions/consultants",
  },
};
      ...
      <main style={{ background: "#09090f", color: "white", fontFamily: "system-ui, -apple-system, sans-serif", paddingTop: 64 }}>
        ...
        <section style={{ position: "relative", overflow: "hidden", padding: "96px 24px 80px", textAlign: "center" }}>
          ...
          <div style={{ maxWidth: 760, margin: "0 auto", position: "relative" }}>
            ...
            <p style={{ fontSize: "clamp(16px, 2.2vw, 20px)", lineHeight: 1.6, color: "rgba(255,255,255,0.55)", margin: "0 0 40px", maxWidth: 600, marginLeft: "auto", marginRight: "auto" }}>
              You&apos;re a one-person operation competing against full agencies. clickr gives you the same output in a fraction of the time — so you can take on more clients, deliver faster, and protect your margin.
            </p>
        ...
        <section style={{ padding: "72px 24px", background: "rgba(255,255,255,0.015)", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
          <div style={{ maxWidth: 860, margin: "0 auto" }}>
            ...
            <h2 style={{ textAlign: "center", fontSize: "clamp(28px, 4vw, 42px)", fontWeight: 800, letterSpacing: "-0.03em", margin: "0 0 48px" }}>
            ...
            <div style={{ borderRadius: 16, overflow: "hidden", border: "1px solid rgba(255,255,255,0.08)" }}>
              ...
              <div style={{
                ...
                <span style={{ fontSize: 12, fontWeight: 700, color: "rgba(255,255,255,0.3)", textTransform: "uppercase", letterSpacing: "0.06em" }}>Task</span>
                <span style={{ fontSize: 12, fontWeight: 700, color: accentLight, textTransform: "uppercase", letterSpacing: "0.06em", textAlign: "center" }}>With clickr</span>
                <span style={{ fontSize: 12, fontWeight: 700, color: "rgba(255,255,255,0.3)", textTransform: "uppercase", letterSpacing: "0.06em", textAlign: "center" }}>Without clickr</span>
              </div>
              {comparisons.map(({ label, clickr, other }, i) => (
                <div key={label} style={{
                  ...
                  <span style={{ fontSize: 13, fontWeight: 600, color: "rgba(20,184,166,0.9)", textAlign: "center" }}>{clickr}</span>
                  <span style={{ fontSize: 13, color: "rgba(255,255,255,0.28)", textAlign: "center" }}>{other}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <section style={{ padding: "72px 24px", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            ...
            <p style={{ textAlign: "center", fontSize: 16, color: "rgba(255,255,255,0.45)", margin: "0 0 56px", maxWidth: 520, marginLeft: "auto", marginRight: "auto" }}>
              No design tool subscription. No developer. No handoff delays. Just a brief and a published, conversion-ready page.
            </p>
        ...
        <section style={{ padding: "80px 24px", textAlign: "center", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
          <div style={{
            ...
            <p style={{ fontSize: 16, color: "rgba(255,255,255,0.5)", margin: "0 0 32px", lineHeight: 1.6 }}>
              Free plan available. No credit card. No lock-in. Build your first client landing page right now.
            </p>
            <Link href="/signup" style={{
              display: "inline-flex", alignItems: "center", gap: 8,
