...
const secondaryFeatures = [
  {
    icon: <Globe size={20} />,
    title: "Publish to lp.bettsandburton.com",
    desc: "Every page goes live at lp.bettsandburton.com/client/{client}/{slug}. Fast global CDN, clean URLs, zero hosting overhead. Custom CNAME on Pro.",
  },
  {
    icon: <Layers size={20} />,
...
const steps = [
  ...
  },
  {
    ...
    title: "Publish",
    desc: "Hit publish. The page goes live at lp.bettsandburton.com/client/{client}/{slug} with your tracking pixels firing, lead capture active, and the URL ready to drop into any ad campaign.",
  },
];
...
const testimonials = [
  {
    quote:
      "We used to spend three days per client on landing pages. Now it's under 30 minutes — brief, generate, tweak, publish. Our margins have genuinely improved and clients see campaigns live faster.",
    name: "James Whitmore",
  ...
  {
    quote:
      "clickr generates pages that actually look like the client's brand. Real copy from their website, their actual colours — not lorem ipsum with a logo slapped on. The chat editor is the bit I didn't know I needed.",
    name: "Sarah Chen",
  ...
  {
    quote:
      "We ran clickr against our old Unbounce setup across 6 campaigns. Average 2.3× improvement in conversion rate. Having a page that matches each campaign's exact message just works. It's not magic — it's basic CRO at scale.",
    name: "Marcus Reid",
    role: "Founder",
...
const faqs = [
  ...
  },
  {
    ...
    a: "Free and Starter plan pages publish to lp.bettsandburton.com/client/{your-slug}. Pro plan pages support custom domains (e.g., landing.yourclient.com) via CNAME. The LP domain is fast, globally distributed, and works perfectly for paid campaigns.",
  },
  {
...
export default function ClickrPage() {
  ...
  const briefText =
    "High-converting summer camp landing page. Target: parents of 8-16 year olds. CTA: enrol now.";
  ...
  return (
    <div style={{ background: "#09090f", color: "white", fontFamily: "inherit" }}>
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              ...
              <span
                ...
                style={{
                  ...
                  background: `linear-gradient(90deg, ${accentLight}, ${accent}, #7c3aed)`,
                  WebkitBackgroundClip: "text",
                  WebkitTextFillColor: "transparent",
                }}
              >
            ...
            >
              Powered by Meridian, i3MEDIA&apos;s proprietary marketing intelligence. Scrape any
              website, generate a fully branded post-click page, and go live at{" "}
              <span style={{ color: accentLight, fontWeight: 600 }}>lp.bettsandburton.com</span>.
              Integrates with your existing CRM, notification stack, and any tool that accepts a
              webhook.
            </p>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 11, marginBottom: 38 }}>
              {[
                ...
                "Publishes to lp.bettsandburton.com/client/{client}/{slug} instantly",
              ].map((item, i) => (
              ...
              <div style={{ display: "grid", gridTemplateColumns: "200px 1fr" }}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      Make the hero headline bigger and more urgent
                    </p>
                  </div>
                  ...
                  >
                    ...
                    >
                      Done. Updated hero to 64px with urgency-driven copy and a countdown element.
                    </p>
                  </div>
                  ...
                  >
                    ...
                    >
                      CTA updated to #14b8a6 with hover state.
                    </p>
                  </div>
                ...
                <div style={{ overflow: "hidden", position: "relative" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        Elite coaching, 5-a-side tournaments,
                        <br />
                        and UEFA Pro licence coaches.
                      </div>
                      <div
                        style={{
                          display: "inline-block",
                    ...
                    >
                      {["⭐ 4.9/5", "200+ Players", "15 Years"].map((s, i) => (
                        <div key={i} style={{ fontSize: 8, fontWeight: 700, color: "#374151" }}>
                          {s}
                        </div>
                      ))}
                    </div>
                    ...
                    >
                      {["Full-day coaching sessions", "Age groups 8–16", "Free kit included"].map(
                        (b, i) => (
                          <div key={i} style={{ display: "flex", alignItems: "center", gap: 6 }}>
                            ...
                            <div style={{ fontSize: 9, color: "#374151", fontWeight: 500 }}>
                              {b}
                            </div>
                          </div>
                        ),
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                  ...
                  <span style={{ fontSize: 9, color: "rgba(255,255,255,0.3)" }}>
                    lp.bettsandburton.com/client/fcv/summer-2026
                  </span>
                </div>
      ...
      <section
        ...
        style={{
          padding: "80px 40px",
          background: `linear-gradient(180deg, rgba(20,184,166,0.05) 0%, rgba(124,58,237,0.04) 100%)`,
            ...
            {[
              {
                ...
                suffix: "s",
                prefix: "~",
                label: "Average time from brief to first published draft",
                note: "Including Meridian generation + scrape",
                color: accent,
              },
              {
                val: s2,
                suffix: "+",
                label:
                  "Campaign types supported: lead gen, e-commerce, events, trials, donations, and more",
                note: "Any paid campaign goal",
                color: "#7c3aed",
              },
              {
                val: s3,
                suffix: "%",
                label:
                  "Of generated pages built with real brand content, not placeholder copy or lorem ipsum",
                note: "Full brand context from scrape",
                color: "#f59e0b",
                isText: false,
              },
            ].map((s, i) => (
      ...
      <section
        className="reveal-section"
        style={{ padding: "72px 40px", borderTop: "1px solid rgba(255,255,255,0.05)" }}
      >
      ...
      <section id="how-it-works" className="reveal-section" style={{ padding: "120px 40px" }}>
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 72 }}>
            ...
            >
              No design briefs. No dev sprints. No agency back-and-forth. Just a URL and a brief,
              and clickr handles the rest.
            </p>
          </div>
              ...
              >
                <div
                  style={{
                    ...
                    right: 0,
                    height: 2,
                    background: `linear-gradient(90deg, rgba(20,184,166,${0.6 - i * 0.1}), transparent)`,
                  }}
                />
      ...
      <section
        id="features"
        style={{ padding: "120px 40px", background: "rgba(255,255,255,0.01)" }}
      >
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: 112 }} className="reveal-section">
            ...
            >
              clickr handles every stage: generation, editing, publishing, tracking, lead routing,
              and notifications. No context switching. No extra subscriptions.
            </p>
          </div>

          {/* ── Feature 1: AI Generation ─────────────────────────────── */}
          <div
            className="reveal-section feat-row"
            style={{
              display: "grid",
          ...
          >
            <div>
              ...
              >
                Paste the client&apos;s website URL. Meridian scrapes brand colours, typography,
                real service descriptions, testimonials, and team content. Every page is populated
                with genuine brand content — not placeholder copy.
              </p>
              <div style={{ display: "flex", flexDirection: "column", gap: 11 }}>
                {[
                  ...
                  <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
                    ...
                    />
                    <span
                      style={{ fontSize: 14, color: "rgba(255,255,255,0.55)", lineHeight: 1.5 }}
                    >
                      {item}
                    </span>
                  </div>
            ...
            <div style={{ position: "relative" }}>
              ...
              >
                ...
                >
                  <div style={{ display: "flex", gap: 5 }}>
                    {["rgba(239,68,68,0.5)", "rgba(251,191,36,0.5)", "rgba(34,197,94,0.5)"].map(
                      (c, i) => (
                        <div
                          key={i}
                      ...
                      <>
                        <div
                          style={{
                            ...
                            borderRadius: "50%",
                            background: accent,
                            animation: "accent-pulse-anim 1s ease-in-out infinite",
                          }}
                        />
                        <span style={{ fontSize: 9, color: accentLight, fontWeight: 600 }}>
                          Scanning…
                        </span>
                      </>
                    )}
                  ...
                  <div style={{ display: "flex", gap: 8, marginBottom: 20 }}>
                    <div
                      style={{
                        ...
                        borderRadius: 8,
                        background: "rgba(255,255,255,0.05)",
                        border: `1px solid ${scrapeStep >= 2 ? "rgba(20,184,166,0.3)" : "rgba(255,255,255,0.1)"}`,
                        fontSize: 12,
                        color: "rgba(255,255,255,0.55)",
                        display: "flex",
                        alignItems: "center",
                    ...
                    >
                      ...
                      <span>
                        {scrapeStep === 0 ? "" : scrapeStep === 1 ? "fcvfoot" : "fcvfootball.co.uk"}
                      </span>
                      {scrapeStep <= 1 && (
                        <span
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 9 }}>
                    ...
                    <div
                      style={{
                        ...
                        borderRadius: 10,
                        background: "rgba(255,255,255,0.03)",
                        border: `1px solid ${scrapeStep >= 4 ? "rgba(34,197,94,0.2)" : "rgba(255,255,255,0.06)"}`,
                    ...
                    >
                      ...
                      >
                        <span
                          style={{ fontSize: 10, fontWeight: 700, color: "rgba(255,255,255,0.45)" }}
                        >
                          Brand colours
                        </span>
                        <span
                          style={{
                            fontSize: 9,
                            color: scrapeStep >= 4 ? "#86efac" : "rgba(255,255,255,0.18)",
                            fontWeight: 600,
                            transition: "color 0.4s ease",
                          }}
                        >
                          {scrapeStep >= 4 ? "✓ Extracted" : "—"}
                        </span>
                      </div>
                      <div style={{ display: "flex", gap: 5 }}>
                        {["#1a3a6b", "#14b8a6", "#ffffff", "#1f2937", "#94a3b8"].map((c, i) => (
                          <div
                            ...
                            style={{
                              ...
                              opacity: scrapeStep >= 4 ? 1 : 0,
                              transition: `transform 0.4s cubic-bezier(0.34,1.56,0.64,1) ${0.05 + i * 0.07}s, opacity 0.3s ease ${0.05 + i * 0.07}s`,
                            }}
                          />
                        ))}
                      </div>
                    ...
                    <div
                      style={{
                        ...
                        borderRadius: 10,
                        background: "rgba(255,255,255,0.03)",
                        border: `1px solid ${scrapeStep >= 5 ? "rgba(34,197,94,0.2)" : "rgba(255,255,255,0.06)"}`,
                        transition: "border-color 0.5s ease",
                      }}
                    >
                      <div
                      ...
                      >
                        ...
                        <span
                          style={{
                            fontSize: 9,
                            color: scrapeStep >= 5 ? "#86efac" : "rgba(255,255,255,0.18)",
                            fontWeight: 600,
                            transition: "color 0.4s ease",
                          }}
                        >
                          {scrapeStep >= 5 ? "✓ 5 found" : "—"}
                        </span>
                      </div>
                        ...
                        {[
                          ...
                          <span
                            ...
                            style={{
                              ...
                              fontSize: 9,
                              color: "rgba(255,255,255,0.45)",
                              opacity: scrapeStep >= 5 ? 1 : 0,
                              transform: scrapeStep >= 5 ? "translateY(0)" : "translateY(8px)",
                    ...
                    <div
                      style={{
                        ...
                        gridTemplateColumns: "1fr 1fr",
                        gap: 8,
                        opacity: scrapeStep >= 6 ? 1 : 0,
                        transform: scrapeStep >= 6 ? "none" : "translateY(10px)",
                        transition: "opacity 0.4s ease, transform 0.4s ease",
                      }}
                    >
                      {[
                        { label: "Testimonials", val: "3 extracted" },
                        { label: "Typography", val: "Poppins / Inter" },
                      ].map((item, i) => (
                        <div
                          key={i}
                          style={{
                        ...
                        >
                          ...
                          <div style={{ fontSize: 10, color: "rgba(255,255,255,0.33)" }}>
                            {item.val}
                          </div>
                        </div>
                      ))}
          ...
          <div
            className="reveal-section feat-row feat-row-rev"
            style={{
              display: "grid",
              gridTemplateColumns: "1fr 1fr",
              gap: 80,
          ...
          >
              ...
              >
                ...
                <div style={{ display: "grid", gridTemplateColumns: "175px 1fr" }}>
                  ...
                  >
                    ...
                    {chatStep >= 1 && (
                      <div
                        style={{
                          ...
                          padding: "6px 8px",
                          animation: "chat-bubble-in 0.35s cubic-bezier(0.34,1.56,0.64,1) both",
                        }}
                      >
                        <p
                          style={{
                        ...
                        >
                          Rewrite headline to emphasise scarcity
                        </p>
                      </div>
                    )}
                    ...
                    {chatStep >= 3 && (
                      ...
                      >
                        ...
                        >
                          Done. 1 change applied in 3 seconds.
                        </p>
                      </div>
                    )}
                    ...
                    >
                      <span style={{ fontSize: 9, color: "rgba(255,255,255,0.15)", flex: 1 }}>
                        Ask clickr…
                      </span>
                      <span
                        className="cursor-blink"
                      ...
                      >
                        <ArrowRight size={8} color={accentLight} />
                      </div>
                    </div>
                  </div>
                  ...
                  <div style={{ overflow: "hidden" }}>
                    ...
                    <div
                      style={{
                        background: chatStep >= 6 ? "#f0fdf4" : "#f8fafc",
                        borderBottom: `2px solid ${chatStep >= 6 ? "#86efac" : "rgba(0,0,0,0.07)"}`,
                        padding: "14px 16px",
                    ...
                    >
                      <div
                        style={{
                          fontSize: 7,
                          fontWeight: 700,
                          color: chatStep >= 6 ? "#16a34a" : "rgba(0,0,0,0.18)",
                          textTransform: "uppercase",
                          letterSpacing: "0.05em",
                          marginBottom: 5,
                          transition: "color 0.4s ease",
                      ...
                      <div
                        style={{
                          fontSize: 12,
                          fontWeight: 800,
                          color: chatStep >= 6 ? "#111827" : "#9ca3af",
                          letterSpacing: "-0.02em",
                          lineHeight: 1.2,
                      ...
                      >
                        {chatStep >= 6 ? (
                          <>
                            Only 4 Spaces Left
                            <br />
                            <span style={{ color: "#14b8a6" }}>for Summer 2026</span>
                          </>
                        ) : (
                          <>Summer Football Camps 2026</>
                        )}
                      ...
                      <div
                        style={{
                          fontSize: 8,
                          color: chatStep >= 6 ? "#374151" : "#9ca3af",
                          marginTop: 4,
                          transition: "color 0.4s ease",
                        }}
                      >
            ...
            <div>
              ...
              >
                No drag-and-drop. No element panels. No wrestling with a builder. Type what you want
                in plain English and clickr edits the actual page HTML — headline, layout, copy,
                colour, structure.
              </p>
              <div style={{ display: "flex", flexDirection: "column", gap: 11 }}>
                {[
          ...
          >
            ...
            <div>
              ...
              >
                Add your tracking IDs from inside the editor. clickr injects the correct pixel code
                and fires conversion events automatically — form submissions, phone clicks, email
                clicks. No GTM fumbling, no dev handoffs.
              </p>
              <div style={{ display: "flex", flexDirection: "column", gap: 11 }}>
                {[
            ...
            <div style={{ position: "relative" }}>
              ...
              >
                      ...
                      <>
                        <div
                          style={{
                            ...
                            animation: "accent-pulse-anim 1.2s ease-in-out infinite",
                          }}
                        />
                ...
                <div style={{ padding: "18px 18px 20px" }}>
                  ...
                  <div
                    style={{ display: "flex", flexDirection: "column", gap: 7, marginBottom: 16 }}
                  >
                    {[
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            border: `1px solid ${isActive ? "rgba(34,197,94,0.18)" : "rgba(255,255,255,0.055)"}`,
                            transition: "background 0.5s ease, border-color 0.5s ease",
                            animation: isJustActivated ? "pixel-glow 0.9s ease-out" : "none",
                          }}
                        >
                            ...
                            {isJustActivated && (
                              <div
                                style={{
                                  ...
                                  animation: "dot-ripple 0.8s ease-out",
                                }}
                              />
                            )}
                          </div>
                          <span
                            style={{
                              fontSize: 10,
                              fontWeight: 700,
                              color: isActive ? pixel.color : "rgba(255,255,255,0.22)",
                              flex: 1,
                              transition: "color 0.5s ease",
                            }}
                          >
                  ...
                  <div
                    style={{ height: 1, background: "rgba(255,255,255,0.055)", marginBottom: 12 }}
                  />
                  <div
                    style={{
                      fontSize: 9,
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            padding: "5px 9px",
                            borderRadius: 7,
                            background: isJustFired
                              ? "rgba(34,197,94,0.12)"
                              : "rgba(34,197,94,0.04)",
                            border: `1px solid ${isJustFired ? "rgba(34,197,94,0.3)" : "rgba(34,197,94,0.09)"}`,
                            opacity: isFired ? 1 : 0.25,
                            transition:
                              "opacity 0.4s ease, background 0.5s ease, border-color 0.5s ease",
                            animation: isJustFired ? "event-flash 1.2s ease-out" : "none",
                          }}
                        >
                          <CheckCircle2
                            size={9}
                            color={isFired ? "#86efac" : "rgba(255,255,255,0.2)"}
                            style={{ flexShrink: 0 }}
                          />
                          <span
                            style={{
                              fontSize: 9,
                              fontFamily: "monospace",
                              color: isFired ? "rgba(255,255,255,0.5)" : "rgba(255,255,255,0.2)",
                              flex: 1,
                            }}
                          >
                            {ev.ev}
                          ...
                          <span
                            style={{
                              fontSize: 9,
                              color: isFired ? "#86efac" : "rgba(255,255,255,0.15)",
                              fontWeight: 600,
                            }}
                          >
                            {ev.n}
                          ...
                          <span
                            style={{
                              fontSize: 8,
                              color: isFired ? "rgba(255,255,255,0.25)" : "rgba(255,255,255,0.1)",
                            }}
                          >
                            {ev.ms}
                          </span>
          ...
          >
            ...
            <div style={{ position: "relative" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 11 }}>
                ...
                <div
                  key={routeStep === 0 ? `lead-${Date.now()}` : "lead"}
                  style={{
                    background: "rgba(13,13,20,0.96)",
                    border: `1px solid rgba(20,184,166,0.2)`,
                    borderRadius: 14,
                    ...
                    animation: "lead-arrive 0.55s cubic-bezier(0.34,1.56,0.64,1) both",
                  }}
                >
                  ...
                  >
                    ...
                    <div style={{ fontSize: 10, color: "rgba(255,255,255,0.3)", marginBottom: 3 }}>
                      james@email.com · 07712 345 678
                    </div>
                    <div
                      style={{ fontSize: 10, color: "rgba(255,255,255,0.42)", fontStyle: "italic" }}
                    >
                      &ldquo;Looking for sessions for my 10-year-old&rdquo;
                    </div>
                  </div>
                ...
                >
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 7 }}>
                    {[
                      ...
                      {
                        dest: "Microsoft Teams",
                        detail: "Notification sent",
                        abbr: "T",
                        color: "#6264a7",
                      },
                      {
                        dest: "hello@fcvfootball.co.uk",
                        ...
                        <div
                          ...
                          style={{
                            ...
                            background: isVisible
                              ? "rgba(34,197,94,0.04)"
                              : "rgba(255,255,255,0.025)",
                            border: `1px solid ${isVisible ? "rgba(34,197,94,0.14)" : "rgba(255,255,255,0.05)"}`,
                            opacity: isVisible ? 1 : 0.2,
                            transform: isVisible ? "translateX(0)" : "translateX(-10px)",
                            transition:
                              "opacity 0.4s ease, transform 0.4s cubic-bezier(0.34,1.56,0.64,1), background 0.4s ease, border-color 0.4s ease",
                          }}
                        >
                          <div
                            style={{
                          ...
                          <span
                            style={{
                              fontSize: 10,
                              fontWeight: 600,
                              color: isVisible ? "rgba(255,255,255,0.7)" : "rgba(255,255,255,0.25)",
                              flex: 1,
                              transition: "color 0.4s ease",
                            }}
                          >
                          ...
                          {isVisible && (
                            <span
                              style={{
                                fontSize: 9,
                                color: "#86efac",
                                animation: "route-reveal 0.4s ease both",
                              }}
                            >
                              ✓ {r.detail}
                            </span>
            ...
            <div>
              ...
              >
                Every form submission is stored in StratOS with full attribution data. Route to your
                CRM, fire a Teams or Slack notification, send a client email, and POST to any
                webhook — all in the same instant.
              </p>
              <div style={{ display: "flex", flexDirection: "column", gap: 11 }}>
                {[
      ...
      >
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            ...
            >
              Unbounce and Instapage charge enterprise prices for drag-and-drop editors. Coding from
              scratch takes days. clickr is the only platform built for AI-native, multi-client
          ...
          >
            ...
            {[
              {
                feature: "Time to first live page",
                clickr: "< 60 seconds",
                unbounce: "30–60 min",
                instapage: "30–60 min",
                handcode: "4–8 hours",
              ...
              {
                feature: "Brand scraping & real content",
                clickr: "✓",
                unbounce: "✗",
                instapage: "✗",
                handcode: "✗",
              ...
              {
                feature: "3-pass AI quality audit (CRO + Design + Copy)",
                clickr: "✓",
                unbounce: "Basic AI",
                instapage: "Basic AI",
                handcode: "✗",
              ...
              {
                feature: "Chat-based page refinement",
                clickr: "✓",
                unbounce: "✗",
                instapage: "✗",
                handcode: "✗",
              ...
              {
                feature: "Magic-link client review",
                clickr: "✓",
                unbounce: "✗",
                instapage: "✗",
                handcode: "✗",
              ...
              {
                feature: "Multi-language pages (20+ langs)",
                clickr: "✓",
                unbounce: "Manual",
                instapage: "Manual",
                handcode: "Manual",
              ...
              >
                ...
                <span
                  style={{
                    fontSize: 13,
                    fontWeight: 700,
                    color: clickr === "✓" ? "#86efac" : accentLight,
                    textAlign: "center",
                  }}
                >
                  {clickr}
                ...
                <span
                  style={{
                    fontSize: 12,
                    color: unbounce === "✗" ? "rgba(255,255,255,0.2)" : "rgba(255,255,255,0.45)",
                    textAlign: "center",
                  }}
                >
                  {unbounce}
                ...
                <span
                  style={{
                    fontSize: 12,
                    color: instapage === "✗" ? "rgba(255,255,255,0.2)" : "rgba(255,255,255,0.45)",
                    textAlign: "center",
                  }}
                >
                  {instapage}
                ...
                <span
                  style={{
                    fontSize: 12,
                    color: handcode === "✗" ? "rgba(255,255,255,0.2)" : "rgba(255,255,255,0.45)",
                    textAlign: "center",
                  }}
                >
                  {handcode}
      ...
      >
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            ...
            >
              clickr connects to the tools your team and clients already use. Leads route to your
              CRM, your team gets notified instantly, and every event can be sent anywhere via
              webhook.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                Route leads directly into your existing CRM the moment a form is submitted. No
                manual exports, no missed follow-ups, no copy-pasting between tabs.
              </p>
            ...
            >
              ...
              >
                Get alerted the moment a lead converts. clickr fires real-time notifications to your
                team via the platforms they already work in, so no conversion ever gets missed.
              </p>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 7 }}>
            ...
            >
              ...
              <p style={{ fontSize: 13, color: "rgba(255,255,255,0.43)", lineHeight: 1.65 }}>
                Every form submission lands in the right inbox automatically. Route to client email
                addresses, internal distribution lists, or any combination of both. No third-party
                form service required, and no setup beyond entering an address.
              </p>
            </div>
            ...
            >
              ...
              >
                Send lead and conversion data to any endpoint that accepts an HTTP POST. Connect
                clickr to Zapier, Make, your own backend, or any custom workflow already running in
                your stack.
              </p>
              <div
                style={{
      ...
      <section className="reveal-section" style={{ padding: "80px 40px 100px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
          ...
          >
            Choose the campaign type when you create a page and clickr optimises the layout, copy
            structure, and CTA hierarchy for maximum conversion.
          </p>
          <div
      ...
      <section
        ...
        style={{
          padding: "100px 40px",
          background: `linear-gradient(180deg, rgba(20,184,166,0.04) 0%, rgba(124,58,237,0.04) 100%)`,
          borderTop: "1px solid rgba(255,255,255,0.05)",
          borderBottom: "1px solid rgba(255,255,255,0.05)",
        }}
      >
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          ...
          >
            <div>
              ...
              >
                Add your tracking IDs from inside the editor. clickr injects the correct pixels into
                the page and fires conversion events automatically when a form is submitted, a phone
                number is clicked, or an email is tapped.
              </p>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  and a floating overlay logs every pixel event that would fire, without sending
                  anything to your ad platforms.
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div
            ...
            className="testimonials-grid stagger-in"
          >
      ...
      <section
        className="reveal-section"
        style={{ padding: "112px 40px", borderTop: "1px solid rgba(255,255,255,0.05)" }}
      >
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
            {faqs.map((faq, i) => (
              <div
                ...
                style={{
                  borderRadius: 14,
                  border: `1px solid ${openFaq === i ? "rgba(20,184,166,0.22)" : "rgba(255,255,255,0.07)"}`,
                  background: openFaq === i ? "rgba(20,184,166,0.04)" : "rgba(255,255,255,0.02)",
                  overflow: "hidden",
                ...
                >
                  <span
                    style={{
                      fontSize: 15,
                      fontWeight: 700,
                      color: openFaq === i ? accentLight : "rgba(255,255,255,0.85)",
                      lineHeight: 1.4,
                    }}
                  >
                    {faq.q}
                  ...
                  <span
                    style={{
                      ...
                      height: 20,
                      borderRadius: "50%",
                      border: `1px solid ${openFaq === i ? "rgba(20,184,166,0.4)" : "rgba(255,255,255,0.15)"}`,
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      fontSize: 14,
                      color: openFaq === i ? accent : "rgba(255,255,255,0.4)",
          ...
          <div style={{ textAlign: "center", marginTop: 48 }}>
            ...
            >
              ...
              <span
                style={{ color: accentLight, textDecoration: "underline", textUnderlineOffset: 3 }}
              >
                Email the team →
              </span>
            </a>
      ...
      <section
        id="cta"
        className="reveal-section"
        style={{ padding: "120px 40px 160px", position: "relative", overflow: "hidden" }}
      >
        <div
          style={{
            position: "absolute",
        ...
        <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center", position: "relative" }}>
          ...
          >
            ...
            />
            <span
              style={{ fontSize: 14, fontWeight: 800, color: accentLight, letterSpacing: "0.04em" }}
            >
              clickr
            </span>
          ...
          >
            Paste a URL. Write a brief. clickr does the rest: a fully branded, conversion-optimised
            landing page, live on lp.bettsandburton.com in under a minute. Connected to your CRM,
            your team notifications, and your tracking from day one.
          </p>
          <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
            <a
              ...
              style={{
                ...
                fontWeight: 700,
                textDecoration: "none",
                boxShadow: `0 0 36px rgba(20,184,166,0.42)`,
              }}
              className="cta-accent-pulse"
            >
