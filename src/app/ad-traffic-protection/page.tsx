    ...
    <div style={{ background: "#09090f", color: "white", fontFamily: "inherit" }}>
      ...
      <nav style={{
        ...
        <div style={{ width: "100%", height: 44, display: "flex", flexDirection: "column", alignItems: "center", gap: 6, marginTop: 8, paddingTop: 8, borderTop: "1px solid rgba(255,255,255,0.07)" }}>
          ...
          <div style={{ width: 2, height: 32, background: "rgba(255,255,255,0.08)", borderRadius: 2, position: "relative", overflow: "hidden" }}>
            <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: `${scrollPct}%`, background: "linear-gradient(180deg, #10b981, #6366f1)", transition: "height 0.1s linear", borderRadius: 2 }} />
          </div>
        </div>
      </nav>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div style={{ width: 7, height: 7, borderRadius: "50%", background: "#10b981", boxShadow: "0 0 8px rgba(16,185,129,0.6)" }} className="stratum-pulse" />
            <span style={{ fontSize: 13, fontWeight: 700, color: "rgba(255,255,255,0.65)", letterSpacing: "0.01em" }}>Ad Traffic Protection</span>
          </div>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <a
          ...
          >
            <span style={{ width: 5, height: 5, borderRadius: "50%", background: "#8b5cf6", boxShadow: "0 0 6px rgba(139,92,246,0.6)", display: "inline-block", flexShrink: 0 }} />
            Meridian AI
      ...
      <section style={{
        ...
        <div style={{
          ...
          bottom: "-15%", right: "-10%", pointerEvents: "none", borderRadius: "50%",
        ...
        {particles.map((p) => (
          <div key={p.id} className="hero-particle" style={{
            ...
            background: p.id % 3 === 0 ? "rgba(16,185,129,0.9)" : p.id % 3 === 1 ? "rgba(99,102,241,0.9)" : "rgba(255,255,255,0.8)",
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 28, flexWrap: "wrap" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "6px 14px", borderRadius: 20, background: "rgba(16,185,129,0.12)", border: "1px solid rgba(16,185,129,0.3)" }}>
                ...
                <span style={{ fontSize: 12, fontWeight: 700, color: "#6ee7b7", letterSpacing: "0.08em", textTransform: "uppercase" }}>Included with every management contract</span>
              </div>
            </div>
            <h1 style={{
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
              ...
              <a href="#comparison" onClick={(e) => { e.preventDefault(); document.getElementById("comparison")?.scrollIntoView({ behavior: "smooth" }); }} style={{
                display: "inline-flex", alignItems: "center", gap: 8,
                padding: "13px 24px", borderRadius: 10,
                background: "rgba(255,255,255,0.06)",
            ...
            <div className="mockup-3d" style={{
              ...
              <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <div>
                    <div style={{ fontSize: 13, fontWeight: 700, color: "white" }}>Ad Traffic Protection</div>
                    <div style={{ fontSize: 11, color: "rgba(255,255,255,0.4)", marginTop: 1 }}>Google Ads · March 2026</div>
                  </div>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 6, padding: "4px 10px", borderRadius: 20, background: "rgba(16,185,129,0.12)", border: "1px solid rgba(16,185,129,0.25)" }}>
                  <div style={{ width: 6, height: 6, borderRadius: "50%", background: "#10b981", boxShadow: "0 0 6px rgba(16,185,129,0.7)" }} className="stratum-pulse" />
                  <span style={{ fontSize: 11, fontWeight: 700, color: "#6ee7b7", letterSpacing: "0.04em" }}>PROTECTED</span>
                </div>
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 0 }}>
                {[
                  { icon: <MousePointerClick size={13} color="#f87171" />, label: "Invalid Clicks", value: "142", sub: "Caught by Google", color: "#fef2f2", border: "#fecaca" },
                  { icon: <ShieldAlert size={13} color="#f87171" />, label: "Invalid Rate", value: "2.8%", sub: "Below 14% avg", color: "#fef2f2", border: "#fecaca" },
                  { icon: <DollarSign size={13} color="#34d399" />, label: "Spend Protected", value: "£487", sub: "Refunded by Google", color: "#f0fdf4", border: "#bbf7d0" },
                ].map((m, i) => (
                  <div key={i} style={{
                    padding: "16px 14px",
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 5, marginBottom: 8 }}>
                      {m.icon}
                      <span style={{ fontSize: 9, fontWeight: 700, color: "rgba(255,255,255,0.35)", textTransform: "uppercase", letterSpacing: "0.06em" }}>{m.label}</span>
                    </div>
                    <div style={{ fontSize: 22, fontWeight: 800, color: "white", letterSpacing: "-0.03em" }}>{m.value}</div>
                    <div style={{ fontSize: 10, color: "rgba(255,255,255,0.3)", marginTop: 3 }}>{m.sub}</div>
                  </div>
                ))}
              </div>
              ...
              <div style={{ padding: "16px 22px", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10 }}>
                  {[
                    ...
                    <div key={i} style={{
                      ...
                      <div style={{ fontSize: 9, color: "rgba(255,255,255,0.3)", textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: 4 }}>{s.label}</div>
                      <div style={{ fontSize: 18, fontWeight: 700, color: s.highlight ? "#f87171" : "white" }}>{s.value}</div>
                    </div>
                  ))}
                </div>
                ...
                <div style={{ display: "flex", gap: 6, marginTop: 10, flexWrap: "wrap" }}>
                  {[
                    { label: "Bot UA: 11", color: "rgba(239,68,68,0.15)", text: "#fca5a5", border: "rgba(239,68,68,0.25)" },
                    { label: "Headless: 7", color: "rgba(234,88,12,0.15)", text: "#fdba74", border: "rgba(234,88,12,0.25)" },
                    { label: "No interaction: 5", color: "rgba(161,98,7,0.15)", text: "#fde047", border: "rgba(161,98,7,0.25)" },
                  ].map((pill) => (
                    <span key={pill.label} style={{
                      fontSize: 10, fontWeight: 600, padding: "3px 8px", borderRadius: 4,
                      background: pill.color, color: pill.text, border: `1px solid ${pill.border}`,
                    }}>{pill.label}</span>
                  ))}
                </div>
              </div>
              ...
              <div style={{ padding: "14px 22px" }}>
                <div style={{ fontSize: 12, color: "rgba(255,255,255,0.45)", lineHeight: 1.6 }}>
                  Google intercepted <strong style={{ color: "white" }}>142</strong> invalid clicks protecting <strong style={{ color: "#34d399" }}>£487</strong> in spend. Your independent snippet flagged <strong style={{ color: "#f87171" }}>23</strong> additional bot visits. Fraud rate of <strong style={{ color: "white" }}>2.8%</strong> is well below the 14% industry average.
                </div>
              </div>
            </div>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 20 }} className="stats-grid">
            {[
              ...
              <div key={i} className="stat-card-3d stagger-in" style={{
                ...
                <div style={{ fontSize: 48, fontWeight: 900, color: "white", letterSpacing: "-0.05em", lineHeight: 1 }}>
      ...
      <section id="problem" className="reveal-section" style={{ padding: "120px 40px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            <p style={{ fontSize: 12, fontWeight: 700, color: "#f87171", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 16 }} className="blur-reveal">
              The problem
            </p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }} className="pains-grid">
            {[
              {
              ...
              <div key={i} className="pain-card stagger-in" style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 18 }}>
                  ...
                  <span style={{ fontSize: 13, fontWeight: 800, color: "rgba(255,255,255,0.9)", textTransform: "uppercase", letterSpacing: "0.06em" }}>{p.platform}</span>
                </div>
                <p style={{ fontSize: 15, fontWeight: 700, color: "white", lineHeight: 1.5, marginBottom: 18 }}>{p.title}</p>
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  {p.points.map((pt, j) => (
                    <div key={j} style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
                      <AlertTriangle size={13} color="#fbbf24" style={{ flexShrink: 0, marginTop: 2 }} />
                      <span style={{ fontSize: 13, color: "rgba(255,255,255,0.6)", lineHeight: 1.6 }}>{pt}</span>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section id="how-it-works" className="reveal-section" style={{
        padding: "120px 40px",
        background: "linear-gradient(180deg, rgba(99,102,241,0.03) 0%, rgba(16,185,129,0.03) 100%)",
      }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 72 }}>
            <p style={{ fontSize: 12, fontWeight: 700, color: "#6ee7b7", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 16 }} className="blur-reveal">
              How it works
            </p>
            <h2 style={{ fontSize: 46, fontWeight: 800, letterSpacing: "-0.03em", marginBottom: 18, color: "white" }} className="blur-reveal">
          ...
          {/* Steps */}
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24, marginBottom: 64 }} className="kit-grid">
            {[
              {
                n: "01",
              ...
              <div key={i} className="stagger-in" style={{
                ...
                <div style={{ fontSize: 48, fontWeight: 900, color: "rgba(255,255,255,0.05)", letterSpacing: "-0.05em", lineHeight: 1, marginBottom: 16 }}>{step.n}</div>
                <div style={{ width: 44, height: 44, borderRadius: 12, background: `rgba(255,255,255,0.05)`, border: `1px solid rgba(255,255,255,0.1)`, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 18 }}>
                  {step.icon}
                </div>
                <h3 style={{ fontSize: 16, fontWeight: 700, color: "white", lineHeight: 1.4, marginBottom: 12 }}>{step.title}</h3>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={i} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
                <div style={{ width: 44, height: 44, borderRadius: 12, background: `rgba(255,255,255,0.04)`, border: `1px solid rgba(255,255,255,0.1)`, display: "flex", alignItems: "center", justifyContent: "center", color: item.color }}>
                  {item.icon}
                </div>
                <span style={{ fontSize: 11, fontWeight: 600, color: "rgba(255,255,255,0.5)", textAlign: "center", whiteSpace: "nowrap" }}>{item.label}</span>
              </div>
            ) : (
      ...
      <section id="google" className="reveal-section" style={{ padding: "120px 40px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 72, alignItems: "center" }}>
            ...
            {/* Left: copy */}
            <div>
              <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "5px 12px", borderRadius: 20, background: "rgba(66,133,244,0.12)", border: "1px solid rgba(66,133,244,0.25)", marginBottom: 24 }}>
                <Globe size={12} color="#93c5fd" />
                <span style={{ fontSize: 11, fontWeight: 700, color: "#93c5fd", letterSpacing: "0.08em", textTransform: "uppercase" }}>Google Ads</span>
              </div>
              <h2 className="blur-reveal" style={{ fontSize: 40, fontWeight: 800, letterSpacing: "-0.03em", marginBottom: 20, color: "white", lineHeight: 1.1 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 14, marginBottom: 28 }}>
                {[
                  ...
                  <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                    ...
                    <span style={{ fontSize: 13, color: "rgba(255,255,255,0.6)", lineHeight: 1.6 }}>{f.text}</span>
                  </div>
                ))}
              </div>
              <div style={{
              ...
              <div style={{
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                  {[
                    ...
                    { label: "Est. Protected", value: "£487", sub: "Typically refunded", warn: false, green: true },
                  ].map((m, i) => (
                    <div key={i} style={{ padding: "18px 16px", borderRight: i < 2 ? "1px solid rgba(255,255,255,0.05)" : "none" }}>
                      <div style={{ fontSize: 9, color: "rgba(255,255,255,0.3)", textTransform: "uppercase", letterSpacing: "0.07em", marginBottom: 6 }}>{m.label}</div>
                      <div style={{ fontSize: 26, fontWeight: 800, color: m.green ? "#34d399" : m.warn ? "#f87171" : "white", letterSpacing: "-0.03em" }}>{m.value}</div>
                ...
                <div style={{ padding: "18px 22px", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
                    <span style={{ fontSize: 11, color: "rgba(255,255,255,0.45)", fontWeight: 600 }}>Your fraud rate vs industry average</span>
                  ...
                  <div style={{ height: 8, background: "rgba(255,255,255,0.06)", borderRadius: 4, position: "relative", overflow: "visible" }}>
                    <div style={{ height: "100%", width: "14%", background: "rgba(255,255,255,0.15)", borderRadius: 4, position: "absolute" }} />
                    <div style={{ height: "100%", width: "2.8%", background: "linear-gradient(90deg, #10b981, #34d399)", borderRadius: 4, position: "absolute", boxShadow: "0 0 8px rgba(16,185,129,0.5)" }} />
                    <div style={{ position: "absolute", left: "14%", top: -18, fontSize: 9, color: "rgba(255,255,255,0.3)", transform: "translateX(-50%)" }}>Avg 14%</div>
                    <div style={{ position: "absolute", left: "2.8%", bottom: -18, fontSize: 9, color: "#34d399", transform: "translateX(-50%)", fontWeight: 700 }}>You: 2.8%</div>
                  </div>
                </div>
                {/* Bot detection breakdown */}
                <div style={{ padding: "18px 22px" }}>
                  <div style={{ fontSize: 11, fontWeight: 700, color: "rgba(255,255,255,0.45)", textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: 12 }}>Independent snippet: reason breakdown</div>
                  {[
                    ...
                    <div key={i} style={{ marginBottom: i < 2 ? 10 : 0 }}>
                      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                        ...
                        <span style={{ fontSize: 11, fontWeight: 700, color: "rgba(255,255,255,0.7)" }}>{r.count}</span>
                      </div>
      ...
      {/* ── META MODULE ── */}
      <section id="meta" className="reveal-section" style={{
        padding: "120px 40px",
        background: "linear-gradient(180deg, rgba(24,119,242,0.03) 0%, rgba(16,185,129,0.02) 100%)",
      }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 72, alignItems: "center" }}>
            ...
            <div className="stagger-in" style={{ animationDelay: "0.1s" }}>
              <div style={{
                ...
                {/* Integrity score */}
                <div style={{ padding: "24px 22px", borderBottom: "1px solid rgba(255,255,255,0.05)", display: "flex", alignItems: "center", gap: 20 }}>
                  <div style={{ position: "relative", width: 88, height: 88, flexShrink: 0 }}>
                    <svg viewBox="0 0 88 88" style={{ transform: "rotate(-90deg)" }}>
                      ...
                      <circle cx="44" cy="44" r="36" fill="none" stroke="url(#metaGrad)" strokeWidth="8" strokeLinecap="round" strokeDasharray={`${2 * Math.PI * 36 * 0.847} ${2 * Math.PI * 36}`} />
                      <defs>
                    ...
                    <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
                      ...
                      <span style={{ fontSize: 8, color: "rgba(255,255,255,0.3)", textTransform: "uppercase" }}>integrity</span>
                    </div>
                  </div>
                  <div>
                    <div style={{ fontSize: 13, fontWeight: 700, color: "white", marginBottom: 6 }}>Click-Through Integrity Score</div>
                    <div style={{ fontSize: 12, color: "rgba(255,255,255,0.5)", lineHeight: 1.6 }}>
                      <strong style={{ color: "white" }}>3,200</strong> outbound clicks recorded by Meta.<br />
                      <strong style={{ color: "white" }}>2,710</strong> landing page views confirmed on site.<br />
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                  <div style={{ padding: "16px 18px", borderRight: "1px solid rgba(255,255,255,0.05)" }}>
                    <div style={{ fontSize: 9, color: "rgba(255,255,255,0.3)", textTransform: "uppercase", letterSpacing: "0.07em", marginBottom: 6 }}>Missing Clicks</div>
                    <div style={{ fontSize: 24, fontWeight: 800, color: "#f87171" }}>490</div>
                    <div style={{ fontSize: 10, color: "rgba(255,255,255,0.3)", marginTop: 3 }}>15.3% of total clicks</div>
                  </div>
                  <div style={{ padding: "16px 18px" }}>
                    <div style={{ fontSize: 9, color: "rgba(255,255,255,0.3)", textTransform: "uppercase", letterSpacing: "0.07em", marginBottom: 6 }}>Est. Spend on Lost Traffic</div>
                    <div style={{ fontSize: 24, fontWeight: 800, color: "#f87171" }}>£612</div>
                    <div style={{ fontSize: 10, color: "rgba(255,255,255,0.3)", marginTop: 3 }}>Proportional to click gap</div>
                  </div>
                </div>

                {/* Placement breakdown */}
                <div style={{ padding: "18px 22px", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                  <div style={{ fontSize: 11, fontWeight: 700, color: "rgba(255,255,255,0.45)", textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: 12 }}>Integrity by placement</div>
                  {[
                    ...
                    <div key={i} style={{ marginBottom: i < 3 ? 10 : 0 }}>
                      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                        <span style={{ fontSize: 11, color: "rgba(255,255,255,0.5)" }}>{pl.label}</span>
                        <span style={{ fontSize: 11, fontWeight: 700, color: pl.warn ? "#f87171" : "#6ee7b7" }}>{pl.score}%</span>
                      </div>
                      <div style={{ height: 4, background: "rgba(255,255,255,0.05)", borderRadius: 2 }}>
                        <div style={{ height: "100%", width: `${pl.score}%`, background: pl.color, borderRadius: 2, opacity: 0.8 }} />
                      </div>
                    </div>
                  ))}
                </div>
                ...
                {/* Recommendation */}
                <div style={{ padding: "14px 22px", background: "rgba(239,68,68,0.06)", display: "flex", alignItems: "flex-start", gap: 10 }}>
                  ...
                  <span style={{ fontSize: 11, color: "rgba(255,255,255,0.55)", lineHeight: 1.5 }}>
                    Audience Network has a 39% drop-off rate. Recommend pausing or excluding this placement to recover an estimated
            ...
            {/* Right: copy */}
            <div>
              <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "5px 12px", borderRadius: 20, background: "rgba(24,119,242,0.12)", border: "1px solid rgba(24,119,242,0.25)", marginBottom: 24 }}>
                <Target size={12} color="#93c5fd" />
                <span style={{ fontSize: 11, fontWeight: 700, color: "#93c5fd", letterSpacing: "0.08em", textTransform: "uppercase" }}>Meta Ads</span>
              </div>
              <h2 className="blur-reveal" style={{ fontSize: 40, fontWeight: 800, letterSpacing: "-0.03em", marginBottom: 20, color: "white", lineHeight: 1.1 }}>
      ...
      <section id="comparison" className="reveal-section" style={{ padding: "120px 40px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            <p style={{ fontSize: 12, fontWeight: 700, color: "#a5b4fc", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 16 }} className="blur-reveal">
              vs the alternatives
            </p>
            <h2 style={{ fontSize: 46, fontWeight: 800, letterSpacing: "-0.03em", marginBottom: 18, color: "white" }} className="blur-reveal">
          ...
          <div style={{ borderRadius: 18, overflow: "hidden", border: "1px solid rgba(255,255,255,0.08)" }}>
            {/* Header row */}
            <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr 1fr", background: "rgba(255,255,255,0.04)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
              <div style={{ padding: "18px 24px" }}>
                <span style={{ fontSize: 11, fontWeight: 700, color: "rgba(255,255,255,0.4)", textTransform: "uppercase", letterSpacing: "0.08em" }}>Feature</span>
              </div>
              {competitors.map((c) => (
                <div key={c.name} style={{
                  ...
                  <div style={{ fontSize: 13, fontWeight: 700, color: c.highlight ? "white" : "rgba(255,255,255,0.6)" }}>{c.name}</div>
                  <div style={{
                    marginTop: 6, padding: "3px 8px", borderRadius: 20,
                    background: c.extra ? "rgba(239,68,68,0.12)" : "rgba(16,185,129,0.12)",
                    border: c.extra ? "1px solid rgba(239,68,68,0.25)" : "1px solid rgba(16,185,129,0.25)",
                    display: "inline-block",
                  }}>
                    <span style={{ fontSize: 10, fontWeight: 700, color: c.extra ? "#fca5a5" : "#6ee7b7" }}>{c.price}</span>
                  </div>
                </div>
              ))}
            </div>
            ...
            {compFeatures.map((feat, fi) => (
              <div key={feat.key} style={{
                ...
                borderBottom: fi < compFeatures.length - 1 ? "1px solid rgba(255,255,255,0.04)" : "none",
                  ...
                  return (
                    <div key={c.name} style={{
                      ...
                      {val === true ? (
                        ...
                        <span style={{ fontSize: 12, color: "rgba(255,255,255,0.5)" }}>{String(val)}</span>
                      )}
                    </div>
                  );
                })}
      ...
      {/* ── PRICING ── */}
      <section id="pricing" className="reveal-section" style={{
        padding: "120px 40px",
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            ...
            <h2 style={{ fontSize: 46, fontWeight: 800, letterSpacing: "-0.03em", marginBottom: 16, color: "white" }} className="blur-reveal">
              Included. Full stop.
            </h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
            ...
            <div className="stagger-in" style={{
              ...
              <div style={{ marginBottom: 24 }}>
                <span style={{ fontSize: 11, fontWeight: 700, color: "rgba(255,255,255,0.4)", textTransform: "uppercase", letterSpacing: "0.08em" }}>Standard</span>
                <div style={{ fontSize: 42, fontWeight: 900, color: "white", letterSpacing: "-0.04em", marginTop: 8, marginBottom: 6 }}>
                  Included
                </div>
                <div style={{ fontSize: 13, color: "rgba(255,255,255,0.4)" }}>with every management contract</div>
              </div>
              ...
              <div style={{
                ...
                background: "rgba(16,185,129,0.08)", border: "1px solid rgba(16,185,129,0.2)",
                fontSize: 12, color: "#6ee7b7", fontWeight: 600, textAlign: "center",
              }}>
            ...
            <div className="stagger-in" style={{
              ...
              <div style={{ position: "absolute", top: 18, right: 20, padding: "4px 10px", borderRadius: 20, background: "rgba(99,102,241,0.2)", border: "1px solid rgba(99,102,241,0.4)" }}>
                <span style={{ fontSize: 10, fontWeight: 700, color: "#a5b4fc" }}>BOLT-ON</span>
              </div>
              <div style={{ marginBottom: 24 }}>
                <span style={{ fontSize: 11, fontWeight: 700, color: "rgba(255,255,255,0.4)", textTransform: "uppercase", letterSpacing: "0.08em" }}>Active Threat Blocking</span>
                <div style={{ fontSize: 42, fontWeight: 900, color: "white", letterSpacing: "-0.04em", marginTop: 8 }}>
                  from £99
                  <span style={{ fontSize: 16, fontWeight: 500, color: "rgba(255,255,255,0.4)" }}>/mo</span>
                </div>
                <div style={{ fontSize: 13, color: "rgba(255,255,255,0.4)", marginTop: 6 }}>£99 under £10k spend · £149 up to £30k · £199 above</div>
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 28 }}>
                {[
          ...
          {/* ROI calculator note */}
          <div style={{ marginTop: 24, padding: "20px 28px", borderRadius: 14, background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 24 }}>
            {[
              { label: "Monthly ad spend", example: "£5,000", note: "Google Ads account" },
              { label: "Typical residual fraud rate", example: "5%", note: "After Google's own filtering" },
              { label: "Your bolt-on ROI", example: "1.5–3×", note: "At £99/month price point" },
            ].map((r, i) => (
              <div key={i} style={{ textAlign: "center" }}>
                <div style={{ fontSize: 9, fontWeight: 700, color: "rgba(255,255,255,0.3)", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 }}>{r.label}</div>
                <div style={{ fontSize: 20, fontWeight: 800, color: "white" }}>{r.example}</div>
                <div style={{ fontSize: 10, color: "rgba(255,255,255,0.3)", marginTop: 4 }}>{r.note}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── CTA ── */}
      <section id="cta" className="reveal-section" style={{
        ...
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center", position: "relative" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "6px 14px", borderRadius: 20, background: "rgba(16,185,129,0.12)", border: "1px solid rgba(16,185,129,0.25)", marginBottom: 28 }}>
            <div style={{ width: 7, height: 7, borderRadius: "50%", background: "#10b981", boxShadow: "0 0 8px rgba(16,185,129,0.6)" }} className="stratum-pulse" />
            <span style={{ fontSize: 12, fontWeight: 700, color: "#6ee7b7", letterSpacing: "0.08em", textTransform: "uppercase" }}>Already included in your contract</span>
          </div>
          <h2 style={{ fontSize: 50, fontWeight: 900, letterSpacing: "-0.04em", marginBottom: 20, color: "white", lineHeight: 1.05 }} className="blur-reveal">
            Your ad budget is being<br />
            <span style={{ background: "linear-gradient(90deg, #34d399, #10b981, #6366f1)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
              protected right now.
            </span>
          </h2>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span>© {new Date().getFullYear()} i3 Media. Ad Traffic Protection is part of StratOS.</span>
        </div>
        <a href="/login" style={{ color: "rgba(255,255,255,0.3)", textDecoration: "none", fontSize: 12 }}>← Back to StratOS</a>
      </div>
