...
export default async function AccessRequestSharePage({ searchParams }: Props) {
  ...
  try {
    ...
    /* invalid token — show empty instructions */
  }

  const platforms = data.platforms ?? ["googleAds", "meta", "linkedin"];
  const agencyName = data.agencyName || "Betts & Burton";
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 700, margin: "32px auto 0", padding: "0 24px" }}>
        ...
        >
          <CheckCircle2
            style={{ width: 16, height: 16, color: "#2563eb", marginTop: 2, flexShrink: 0 }}
          />
          <div style={{ fontSize: 13, color: "#1e40af", lineHeight: 1.5 }}>
            <strong>{agencyName}</strong> need access to your ad accounts to carry out a thorough
            audit and set up reporting. Please follow the steps below for each platform — it should
            take around 5 minutes in total. If you have any questions, reply to the email you
            received.
          </div>
        </div>
        ...
        {includeGoogleAds && (
          ...
          >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, color: "#6b7280" }}>
                    Standard or Admin access requested
                  </div>
                </div>
              </div>
              <a
            ...
            <div style={{ padding: "20px", "--color": "#4285F4" } as React.CSSProperties}>
              <InstructionStep
                number={1}
                text='Log in to <a href="https://ads.google.com" target="_blank" rel="noopener noreferrer" style="color:#4285F4;text-decoration:none;font-weight:600">Google Ads</a>'
              />
              <InstructionStep
                number={2}
              ...
              {agencyEmail && (
                <InstructionStep
                  number={5}
                  text={`Enter our email address: <strong>${agencyEmail}</strong>`}
                />
              )}
              {!agencyEmail && (
                <InstructionStep
                  number={5}
                  text="Enter the email address provided by your account manager"
                />
              )}
              <InstructionStep
                number={agencyEmail ? 6 : 6}
                text='Set the access level to <strong>"Standard"</strong> — this gives full campaign management without billing access'
              />
              <InstructionStep
                number={agencyEmail ? 7 : 7}
                text='Click <strong>"Send invitation"</strong>'
              />
              ...
              {managerIdFormatted && (
                <>
                  ...
                  <InstructionStep
                    number={3}
                    text={`Enter our Manager Account ID: <strong style="font-family:monospace;font-size:15px;letter-spacing:0.05em">${managerIdFormatted}</strong>`}
                  />
                  <InstructionStep
                    number={4}
                    text='Click <strong>"Send link request"</strong> — we will approve it promptly'
                  />
                </>
              )}
            </div>
        ...
        {includeMeta && (
          ...
          >
            ...
            <div style={{ padding: "20px", "--color": "#0866FF" } as React.CSSProperties}>
              <InstructionStep
                number={1}
                text='Log in to <a href="https://business.facebook.com" target="_blank" rel="noopener noreferrer" style="color:#0866FF;text-decoration:none;font-weight:600">Meta Business Manager</a>'
              />
              <InstructionStep
                number={2}
                text="Click the <strong>⚙️ Business Settings</strong> gear icon in the left-hand sidebar"
              />
              <InstructionStep
                number={3}
                text='In the left menu, select <strong>"Ad Accounts"</strong>'
              />
              <InstructionStep
                number={4}
                text="Select the ad account you want to share — if you have multiple, you may need to repeat this for each"
              />
              <InstructionStep number={5} text='Click <strong>"Assign Partners"</strong>' />
              {data.metaBusinessId ? (
                <InstructionStep
                  number={6}
                  text={`Enter our Business Manager ID: <strong style="font-family:monospace;font-size:15px;letter-spacing:0.05em">${data.metaBusinessId}</strong>`}
                />
              ) : (
                <InstructionStep
                  number={6}
              ...
              <InstructionStep
                number={7}
                text='Select access level: <strong>"Advertiser"</strong> (gives us full campaign management)'
              />
        ...
        {includeLinkedIn && (
          ...
          >
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, color: "#6b7280" }}>
                    Account Manager access requested
                  </div>
                </div>
              </div>
              <a
            ...
            <div style={{ padding: "20px", "--color": "#0A66C2" } as React.CSSProperties}>
              <InstructionStep
                number={1}
                text='Log in to <a href="https://www.linkedin.com/campaignmanager" target="_blank" rel="noopener noreferrer" style="color:#0A66C2;text-decoration:none;font-weight:600">LinkedIn Campaign Manager</a>'
              />
              <InstructionStep
                number={2}
              ...
              <InstructionStep
                number={3}
                text='Select <strong>"Account Settings"</strong> from the dropdown menu'
              />
              <InstructionStep
                number={4}
              ...
              {agencyEmail ? (
                ...
                <InstructionStep
                  number={6}
                  text="Enter the email address your account manager provided"
                />
              )}
              <InstructionStep
                number={7}
                text='Set the role to <strong>"Account Manager"</strong> for full access'
              />
          ...
          >
            ...
            <div style={{ padding: "20px", "--color": "#E37400" } as React.CSSProperties}>
              <p style={{ margin: "0 0 16px", fontSize: 13, color: "#6b7280" }}>
                We need <strong>two email addresses</strong> added — one for your account manager
                and one for our automated reporting system.
              </p>
              ...
              <InstructionStep
                number={1}
                text='Log in to <a href="https://analytics.google.com" target="_blank" rel="noopener noreferrer" style="color:#E37400;text-decoration:none;font-weight:600">Google Analytics</a> with the account that has admin access to your property'
              />
              <InstructionStep
                number={2}
              ...
              {agencyEmail ? (
                <InstructionStep
                  number={5}
                  text={`Enter our email: <strong>${agencyEmail}</strong>`}
                />
              ) : (
                <InstructionStep
                  number={5}
              ...
              >
                Step 2 — Add our reporting system
              </div>
              <p style={{ margin: "0 0 12px", fontSize: 13, color: "#6b7280" }}>
                Repeat steps 4–7, but use these details instead:
              </p>
              <InstructionStep
                number={4}
                text='Click the <strong>"+"</strong> button → <strong>"Add users"</strong>'
              />
              <InstructionStep
                number={5}
                text='Enter the service account email: <strong style="font-family:monospace;font-size:13px">Betts & Burton@bettsandburton-reports.iam.gserviceaccount.com</strong>'
              />
              ...
              >
                This address is used by our reporting tool to pull your analytics data
                automatically. It cannot make any changes to your account.
              </div>
            </div>
          </section>
        )}
        ...
        {includeSearchConsole && (
          ...
          >
            ...
            <div style={{ padding: "20px", "--color": "#34A853" } as React.CSSProperties}>
              ...
              <InstructionStep
                number={1}
                text='Log in to <a href="https://search.google.com/search-console" target="_blank" rel="noopener noreferrer" style="color:#34A853;text-decoration:none;font-weight:600">Google Search Console</a>'
              />
              <InstructionStep
                number={2}
              ...
              <InstructionStep
                number={3}
                text="Click the <strong>⚙️ Settings</strong> icon at the bottom of the left sidebar"
              />
              ...
              <p style={{ margin: "0 0 12px", fontSize: 13, color: "#6b7280" }}>
                Repeat steps 5–8, but use these details instead:
              </p>
              <InstructionStep number={5} text='Click <strong>"Add User"</strong>' />
              <InstructionStep
                number={6}
              ...
              >
                <strong>Note:</strong> You need to be an <strong>Owner</strong> of the property to
                add users. The service account address is used by our reporting tool to read your
                search data automatically — it cannot make any changes.
              </div>
            </div>
          </section>
        )}
        ...
        >
          <p style={{ margin: 0 }}>
            Sent by <strong style={{ color: "#6b7280" }}>{agencyName}</strong> · Any questions?
