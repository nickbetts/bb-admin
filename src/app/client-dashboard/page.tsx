...
const features = [
  ...
  },
  {
    ...
    title: "34 dashboard panels",
    desc: "Each channel gets its own section with the metrics that matter. Sessions, conversions, ROAS, CTR, email opens, call tracking, rankings. All in one scroll.",
  },
  {
    icon: <Zap size={20} />,
    title: "AI-powered overview",
    desc: "Meridian reads every connected platform and writes a plain-English summary of what happened, what changed, and what needs attention.",
  },
  {
    icon: <Target size={20} />,
    title: "Per-channel drill-down",
    desc: "Click into any section for campaign-level data, ad group breakdowns, audience segments, and device splits. No switching tools.",
  },
  {
    icon: <Activity size={20} />,
    title: "Integration badges",
    desc: "See which platforms are connected for each client at a glance. Green means live. Grey means not yet configured. Simple.",
  },
  {
    icon: <Globe size={20} />,
    title: "One-click report generation",
    desc: "Hit the report button from any client dashboard. We pull the data, the AI writes the commentary, and you have a draft in minutes.",
  },
];
    ...
    <div style={{ background: "#09090f", color: "white", fontFamily: "inherit" }}>
      ...
      >
        ...
        >
          <div>
            ...
            >
              16 marketing channels feeding live data into a single client view. GA4, Google Ads,
              Meta, TikTok, LinkedIn, Klaviyo, and more. No more logging into five platforms before
              your morning coffee.
            </p>
            ...
            {[
              {
                val: s1,
                suffix: "",
                label: "Marketing channels integrated and feeding live data",
                note: "GA4, Google Ads, Meta, and 13 more",
                color: accent,
              },
              {
                val: s2,
                suffix: "",
                label: "Dashboard panels across all connected platforms",
                note: "Each with drill-down capability",
                color: "#10b981",
              },
              {
                val: s3,
                suffix: "s",
                label: "Average data refresh time from platform APIs",
                note: "Cached and rate-limit aware",
                color: "#f59e0b",
              },
              {
                val: s4,
                suffix: " min",
                label: "Typical onboarding time to connect a new client",
                note: "Credentials in, dashboard live",
                color: "#ec4899",
              },
            ].map((s, i) => (
              <div
      ...
      <section id="features" className="reveal-section" style={{ padding: "120px 40px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            ...
            >
              Each client gets a single dashboard pulling live data from every platform they use. No
              extra logins, no switching tabs, no copy-pasting numbers into spreadsheets.
            </p>
          </div>
          <div
          ...
          >
            ...
            <div style={{ padding: "18px 28px", background: "rgba(99,102,241,0.03)" }}>
              ...
              <div style={{ fontSize: 13, color: "rgba(255,255,255,0.45)", lineHeight: 1.7 }}>
                Sessions up 14.2% month-on-month, driven primarily by a 31% jump in organic traffic
                following the March content push. Google Ads ROAS improved to 5.8x after pausing
                three underperforming ad groups. Meta CPA dropped 18% with the new lookalike
                audience. Klaviyo email revenue steady at £4,200.
              </div>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center", position: "relative" }}>
          ...
          >
            Every i3 client gets a unified dashboard from day one. Connect your platforms, and the
            data starts flowing. AI writes the summary. Reports build themselves. Your team focuses
            on strategy, not screenshots.
          </p>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span>
            &copy; {new Date().getFullYear()} i3 Media. Client Dashboard is part of StratOS.
          </span>
        </div>
        <a
          href="/login"
